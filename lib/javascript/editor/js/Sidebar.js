 ...
 */
 Sidebar.prototype.init = function()
 {
	...
	// 	';whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;strokeWidth=2');
	this.addBackground('Background','<img alt="Background" style="width:100%;height=100%;" src="lib/images/background.png"/>',dir+'/background/','',[
		'1.jpg','2.png','3.png','4.png','5.png','6.png','7.png','8.png','9.png','10.png','12.png','13.png','14.png'
		],null,null);
		this.addAlberaTitlesPalette();
		this.addImagePalette('baseTenBlocks', '<img alt="Base ten blocks" style="width:100%;height=100%;" src="lib/images/baseTenBlocks.png"/>', dir + '/baseTenBlocks/', '',
		['1.png','2.png','3.png','4.png'], null,
		{'Wireless_Router_N': 'wireless router switch wap wifi access point wlan',
		'Router_Icon': 'router switch'});
		this.addImagePalette('thermometer', '<img alt="Thermometer" style="width:100%;height=100%;" src="lib/images/thermometer.png"/>', dir + '/thermometer/', '',
		['1.png'], null,
		{'Wireless_Router_N': 'wireless router switch wap wifi access point wlan',
		'Router_Icon': 'router switch'});
...
Sidebar.prototype.addIntegerCounterPalette = function (expand) {
	...
	this.addPaletteFunctions('integerCounters', '<img alt="Integer counters" style="width:100%;height=100%;" src="lib/images/integerCounters.png"/>', (expand != null) ? expand : true, fns);
};
/**
...
Sidebar.prototype.addPatternBlocksPalette = function (expand) {
	...
	this.addPaletteFunctions('patternblocks', '<img alt="Pattern blocks" style="width:100%;height=100%;" src="lib/images/patternBlocks.png"/>', (expand != null) ? expand : true, fns);
};
/**
...
Sidebar.prototype.addAlberaTitlesPalette = function (expand) {
	...
	this.addPaletteFunctions('alberaTitles', '<img alt="Algebra titles" style="width:100%;height=100%;" src="lib/images/algebraTitles.png"/>', (expand != null) ? expand : true, fns);
};
/**
