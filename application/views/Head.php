...
<link href="<?= base_url() ?>/lib/fontawesome-free-5.8.1/css/all.css" rel="stylesheet">
<!--load all styles -->
<link rel="icon" href="<?= base_url() ?>/lib/images/favicon.png">

<!-- framework mxGraph -->
<link rel="stylesheet" type="text/css"
    href="<?= base_url() ?>/lib/javascript/editor/styles/grapheditor.css?v=<?= $version ?>">
...
<script type="text/javascript" src="<?= base_url() ?>/lib/javascript/editor/deflate/pako.min.js?v=<?= $version ?>">
</script>
<script type="text/javascript" src="<?= base_url() ?>/lib/javascript/editor/deflate/base64.js?v=<?= $version ?>">
</script>
<script type="text/javascript" src="<?= base_url() ?>/lib/javascript/editor/jscolor/jscolor.js?v=<?= $version ?>">
</script>
<script type="text/javascript"
    src="<?= base_url() ?>/lib/javascript/editor/sanitizer/sanitizer.min.js?v=<?= $version ?>"></script>
...
<script type="text/javascript" src="<?= base_url() ?>/lib/javascript/editor/js/mxFreehand.js?v=<?= $version ?>">
</script>
