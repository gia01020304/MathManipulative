...
Sidebar.prototype.addNumberLine=function (expand){
	...
	this.addEntry(null,function () {
		...
		var group = new mxCell(null, new mxGeometry(0,0,600,200), 'resizable=0;');
		group.setVertex(true);
		group.setConnectable(false);
		
		var numberLine=graph.insertVertex(group, null,null, 0, 0, 600, 100, 'resizable=0;shape=numberline;movable=0;rotatable=0;editable=0');
		numberLine.vertex=true;
		numberLine.geometry.relative = true;
		numberLine.connectable=false;
		var footer=new mxCell(null, new mxGeometry(0, 100,600,100),"resizable=0;fillColor=white;movable=0;rotatable=0");
		footer.vertex=true;
		footer.connectable=false;


		var minimumLabel = graph.insertVertex(footer, null, 'Minimum',0.1, 0.5,0,0, 'constituent=1;resizable=0;movable=0;rotatable=0;editable=0', true);
		var minimum=graph.insertVertex(footer, null, '-5',0.15,0.4, 50, 25, 'constituent=1;resizable=0;movable=0;rotatable=0', true);

		var interValLabel = graph.insertVertex(footer, null, 'Interval',0.3, 0.5,0,0, 'constituent=1;resizable=0;movable=0;rotatable=0;editable=0', true);
		var interVal=graph.insertVertex(footer, null, '1',0.35,0.4, 50, 25, 'constituent=1;resizable=0;movable=0;rotatable=0', true);

		var maximumLabel = graph.insertVertex(footer, null, 'Maximum',0.5, 0.5,0,0, 'constituent=1;resizable=0;movable=0;rotatable=0;editable=0', true);
		var maximum=graph.insertVertex(footer, null, '5',0.55,0.4, 50, 25, 'constituent=1;resizable=0;movable=0;rotatable=0', true);

		var build=new mxCell("Build", new mxGeometry(500,75,100,25),"resizable=0;fillColor=#D7D7D7;constituent=1;movable=0;rotatable=0;editable=0;");
		build.vertex=true;
