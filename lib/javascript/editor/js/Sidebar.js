 ...
 */
 Sidebar.prototype.addPatternBlocksPalette = function (expand) {
 	...
 	this.createVertexTemplateEntry('triangle;rotation=-90;aspect=fixed;editable=0;whiteSpace=wrap;html=1;fillColor=#23DE88', 120, 160, '', 'Triangle', null, null, 'triangle logic inverter buffer'),
 ...
 */
 Sidebar.prototype.addAttributeBlocksPalette = function (expand) {
 	...
 	var fns = [
 	this.createVertexTemplateEntry('triangle;editable=0;rotation=-90;aspect=fixed;whiteSpace=wrap;html=1;fillColor=#FDFD48', 90, 120, '', 'Triangle', null, null, 'triangle logic inverter buffer'),
