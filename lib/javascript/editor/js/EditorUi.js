 ...
 */
 EditorUi.prototype.menubarHeight = 50;
 ...
 */
 EditorUi.prototype.footerHeight = 80;
 ...
 */
 EditorUi.prototype.createDivs = function()
 {
	...
	this.footerContainer.style.zIndex = 1;
 ...
 */
 EditorUi.prototype.createUi = function()
 {
	...
	divWrap.className='d-flex';

	var divLeft=document.createElement('div');
	divLeft.className='d-flex';

	var divRight=document.createElement('div');

	var divLogo=document.createElement('div');
	divLogo.innerHTML=`<img style="width: 50px; height: 50px; display: block; margin-left: auto; margin-right: auto;" src = '${pathRelative}/lib/images/logo.png' alt ="logo">`;

	var divFileName=document.createElement('h3');
	divFileName.innerHTML='Untitled';
	divFileName.id='divFileName';

	divLeft.appendChild(divLogo);
	divLeft.appendChild(divFileName);

	divRight.id='divAuthen';


	divWrap.appendChild(divLeft);
	divWrap.appendChild(divRight);

	this.menubar.container.innerHTML='';
	this.menubar.container.appendChild(divWrap);
	...
	// Creates the footer
	var footer = (this.editor.chromeless) ? null : this.createFooter(this.footerContainer);
	if (footer != null)
	{
 ...
 */
 ...
 {
 	return new Footer(this, container);
 };
