 ...
 */
 Sidebar.prototype.init = function()
 {
	...
	this.addBackground('Background','Backgrounds',dir+'/background/','',[
		'1.jpg','2.png','3.png','4.png','5.png','6.png','7.png','8.png','9.png','10.png','12.png','13.png','14.png'
		],null,null);
 ...
 */
 Sidebar.prototype.addAlberaTitlesPalette = function (expand) {
 	...
 	var fns = [
 	this.createVertexTemplateEntry('html=1;whiteSpace=wrap;aspect=fixed;fontFamily=Comic Sans MS;fontStyle=1;fillColor=#D13433;', 80, 80, `<span style="font-size:${80 * 0.5}px;font-height:bold;">-x<sup>2</sup></span>`, '', true, null, 'comic rectangle rect box text retro',false, 'algebra'),
 	this.createVertexTemplateEntry('html=1;whiteSpace=wrap;aspect=fixed;fontFamily=Comic Sans MS;fontStyle=1;fillColor=#6DB0CE;', 80, 80, `<span style="font-size:${80 * 0.5}px;font-height:bold;">x<sup>2</sup> </span>`, '', true, null, 'comic rectangle rect box text retro',false, 'algebra'),
 	this.createVertexTemplateEntry('html=1;whiteSpace=wrap;aspect=fixed;fontFamily=Comic Sans MS;fontStyle=1;fillColor=#2C883E;', 20, 80, `<span style="font-size:${20 * 0.5}px;font-height:bold;">x</span>`, '', true, null, 'comic rectangle rect box text retro',false, 'algebra'),
 	this.createVertexTemplateEntry('html=1;whiteSpace=wrap;aspect=fixed;fontFamily=Comic Sans MS;fontStyle=1;fillColor=#D13433;', 20, 80, `<span style="font-size:${20 * 0.5}px;font-height:bold;">-x</span>`, '', true, null, 'comic rectangle rect box text retro',false, 'algebra'),
 	this.createVertexTemplateEntry('html=1;whiteSpace=wrap;aspect=fixed;fontFamily=Comic Sans MS;fontStyle=1;fillColor=yellow;', 30, 30, `<span style="font-size:${30 * 0.5}px;font-height:bold;">1</span>`, '', true, null, 'comic rectangle rect box text retro',false, 'algebra'),
 	this.createVertexTemplateEntry('html=1;whiteSpace=wrap;aspect=fixed;fontFamily=Comic Sans MS;fontStyle=1;fillColor=#D13433;', 30, 30, `<span style="font-size:${30 * 0.5}px;font-height:bold;">-1</span>`, '', true, null, 'comic rectangle rect box text retro',false, 'algebra'),
 	];
 ...
 */
 ...
 {
 	var sb = this;
 	var field = new mxCell('', new mxGeometry(0, 0, 80, 32), 'shape=umlFrame;rotatable=0;fillColor=#64AA50;perimeter=stepPerimeter;fixedSize=1;points=[];resizable=0');
 	field.vertex = true;
 	var field1 = new mxCell('', new mxGeometry(0, 0, 80, 32), 'shape=umlFrame;rotatable=0;fillColor=#7E21AE;perimeter=stepPerimeter;fixedSize=1;points=[];resizable=0');
 	field1.vertex = true;
 	var field2 = new mxCell('', new mxGeometry(0, 0, 80, 32), 'shape=umlFrame;rotatable=0;fillColor=#C81E1E;perimeter=stepPerimeter;fixedSize=1;points=[];resizable=0');
 	field2.vertex = true;
 	var field3 = new mxCell('', new mxGeometry(0, 0, 80, 32), 'shape=umlFrame;rotatable=0;fillColor=#C1C831;perimeter=stepPerimeter;fixedSize=1;points=[];resizable=0');
 	field3.vertex = true;
 	return [
 	this.addEntry('list group erd table', function()
 	{
 ...
 */
 ...
 Sidebar.prototype.addBackground=function (id, title, prefix, postfix, items, titles, tags) {
 	...
 	this.addPaletteFunctions(title, title, false, fns, isBackground);
 }
/**
