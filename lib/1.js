...
function saveFile() {
	...
	if (isNewFile==true) {
		...
		debugger;
		saveShare(createValue(),isNewFile,$('#divFileName').text());
	}
}
...
function processFeature() {
	...
	switch (type) {
		...
		break;
		case 2:
		share(createValue(),$('#divFileName').text());
		$('#divType').val(0);
		break
		case 3:
		saveFile();
