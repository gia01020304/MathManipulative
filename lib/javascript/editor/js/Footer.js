 ...
 Footer.prototype.addLogo=function(){
	var div =document.createElement('div');
	div.id="logo";
 ...
 Footer.prototype.addRuler=function(container) {
 	...
 	img.src=pathRelative+'/lib/images/ruler.png';
 ...
 Footer.prototype.addRemoveAll=function (container){
 	...
 	div.src=pathRelative+"/lib/images/clear.png";
 	div.style.cursor = "pointer";
 	div.addEventListener('click', (e)=>{
...
Footer.prototype.addHand=function (container) {
	...
	var img=document.createElement('img');
	img.src=pathRelative+'/lib/images/hand.png';
	img.style.width='25px';
	img.style.height='25px';
	div.appendChild(img);
	container.appendChild(div);
}
Footer.prototype.addLogoImg = function(container) {
	var div=createDivLogo("Logo");
	var img=document.createElement('img');
	img.src='http://localhost:81/MathManipulative1/MathManipulative/lib/images/logo.png';
...
Footer.prototype.addRemoveBackground=function (container){
	var div=createDivToolBox("removeBackground","Remove background");
	div.addEventListener('click', (e)=>{
		var editor = this.editorUi;
		editor.setBackgroundImage(null);
	});
	var img=document.createElement('img');
	img.src=pathRelative+'/lib/images/removeBackground.png';
	img.style.width='25px';
	img.style.height='25px';
	div.appendChild(img);
	container.appendChild(div);
