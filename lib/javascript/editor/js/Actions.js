 ...
 */
 ...
 function processTransferRuler(graph,value,typeRuler,width,height,x,y,oldObject) {
 	...
 	try {
 		...
 		var cell = graph.insertVertex(parent, null, null, x,y, width+40+20, 100, 'editable=0;resizable=0;aspect=fixed;shape='+typeRuler);

 		
 		var symbol2 = new mxCell('', new mxGeometry(0.96,0.1,20,20),'editable=0;resizable=0;aspect=fixed;rotationEnabled=0;constituent=1;');
 		symbol2.value="X";
 		symbol2.identity = "hide-ruler";
 		symbol2.connectable=false;
 		symbol2.geometry.relative = true;
 		...
 		var symbol = new mxCell('', new mxGeometry(1,1,50,20),'editable=0;resizable=0;aspect=fixed;rotationEnabled=0;constituent=1;');
 		symbol.value=value;
