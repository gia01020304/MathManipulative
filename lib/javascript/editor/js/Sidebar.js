 ...
 * Creates a drop handler for inserting the given cells.
 */
 Sidebar.prototype.createVertexTemplateEntry = function(style, width, height, value, title, showLabel, showTitle, tags,isBackground=false)
 {
 	...
 	return this.addEntry(tags, mxUtils.bind(this, function()
 	{
 		...
 		return this.createVertexTemplate(style, width, height, value, title, showLabel, showTitle,null,isBackground);
 	}));
 }
 ...
 * Creates a drop handler for inserting the given cells.
 */
 Sidebar.prototype.createVertexTemplate = function(style, width, height, value, title, showLabel, showTitle, allowCellsInserted,isBackground)
 {
