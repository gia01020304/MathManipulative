 ...
 Actions.prototype.init = function()
 {
	...
	this.addAction('protractor',(elt)=>{
		if (typeof graph.idProtractor!=="undefined"&&graph.idProtractor!==null) {
 			var cell=graph.getModel().getCell(graph.idProtractor);
		...
		try {
			var pt = graph.getFreeInsertPoint();
			var v1 = graph.insertVertex(parent, null, null, pt.x,pt.y , 400, 275, 'editable=0;resizable=0;aspect=fixed;shape=protractor');
			graph.selectCellForEvent(v1);
 ...
 */
 ...
 function processTransferRuler(graph,value,typeRuler,width,height,x,y,oldObject) {
 	...
 	try {
 		...
 		var v1 = graph.insertVertex(parent, null, null, x,y, width+40+20, 100, 'editable=0;resizable=0;aspect=fixed;shape='+typeRuler);
 		graph.selectCellForEvent(v1);
