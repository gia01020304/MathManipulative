...
Sidebar.prototype.addNumberLine=function (expand){
	...
	this.addEntry(null,function () {
		...
		var cell = new mxCell(null, new mxGeometry(0, 0,600,230),
			'editable=0;resizable=0;aspect=fixed;shape=numberline;Maximum=5;Minimum=-5;Interval=1');
		cell.vertex = true;
		cell.identity="NumberLinePro";
		var footer=new mxCell(null, new mxGeometry(0, 140,600,90),"editable=0;deletable=0;movable=0;resizable=0;fillColor=white;rotatable=0;");
		footer.vertex=true;
