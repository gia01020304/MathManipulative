 		...
 		if (style != null)
 		{
 			...
 			else if (style['childLayout'] == 'flowLayout')
 			{
				...
				return flowLayout;
				 ...
				 var layout = new mxCircleLayout(this.graph,180);
				 layout.x0 = 100;
				 layout.y0 = 100;
				 return layout;
			}
			...
			if (shape.nodeType == mxConstants.NODETYPE_ELEMENT)
			{
				...
				if (name != null)
				{
					...
					if (postStencilLoad != null)
					{
						...
						postStencilLoad(packageName, stencilName, name, w, h,id);
					}
				}
			}
 ...
 */
 if (typeof mxVertexHandler != 'undefined')
 {
 	(function()
 	{
		...
		Graph.prototype.insertTextToolClick = function(evt, cell)
		{
			if (this.isEnabled())
			{
		 ...
		 */
		 Graph.prototype.addText = function(x, y, state)
		 {
			...
			label.value = 'Type text here';
			label.style = 'text;html=1;resizable=0;points=[];fontSize=24;'
