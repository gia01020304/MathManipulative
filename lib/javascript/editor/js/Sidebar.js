 ...
 */
 Sidebar.prototype.init = function () {
 	...
 	for (var i = 0; i < menus.length; i++) {
 		switch (menus[i]) {
 			case "background":
 			this.addBackground('Backgrounds', 'Backgrounds', dir + '/background/', '', [
 				'blankCalendar.jpg', 'centimeterGrid.png', 'inchGrid.png', 'coordinateGrid.png', 'hundredChart.png', 'placeValueHundred.png', 'placeValueThousand.png', 'placeValueDecimals.png', 'tenFrame.png', 'inout.png', 'partpartwhole.png', 'numberLine1.png', 'numberLine2.png', 'numberLine3.png', 'numberLine4.png', 'bardiagram.png', 'geoboard.jpg', 'twoColumns.png' ,'algebraMath.png','quationChart.png', 'firstQuadrant.png', 'productMat.png', 'negativeNumberLine.png', 'Numbers1.png', 'Numbers2.png' , 'linenotick.png' ,'opennumberline.png'
 				], ["Blank Calendar", "Centimeter Grid", "Inch Grid", "Coordinate Grid", "Hundreds Chart", 'Place Value Chart (Hundreds)', 'Place Value Chart (Billions)', 'Place Value Chart (Decimals)', 'Ten Frames', 'In/Out Tables', 'Part Part Whole Chart', 'Number Line (0 - 30)', 'Number Line (31 - 60)', 'Number Line (61 - 100)', 'Number Line (Empty)', 'Bar Model', 'Geoboards', '2 Columns' , 'Algebra Mat', 'Equation Chart', '1 quadrant', 'Product Mat', 'Negative Number Line', 'Numbers 1', 'Numbers 2', 'Open Number Line No Ticks', 'Open Number Line'], null);
 			break;
 			case "attributeBlock":
 			this.addAttributeBlocksPalette(false);
 			break;
 			case "algebraTiles":
 			this.addAlberaTitlesPalette(false);
 			break;
 			case "baseTenBlocks":
 			this.addBaseTenBlock(false);
 			break;
 			case "centimeterCubes":
 			this.addCentimeterCubes(false);
 			break;
 			case "connectingcubes":
 			this.addConnectingCubesPalette(false);
 			break;
 			case "clock":
 			this.addClock(false);
 			break;
 			...
 			if(!isSafari) {
 				this.addIntegerCounterPalette(false);
 			} else{
 				this.addIntegerCounterPaletteWhenNotSupport(false);
 			}
 			break;
 			case "fractionTiles":
 			this.addFractionTilePalette(false);
 			break;
			// case "fractioncircle":
			// 	this.addFractionCirclePalette(false);
			// 	break;
			case "money":
			this.addMoneyPalette('money', '<div class="menu-item"><span>Money</span></div>', dir + '/moneys/', '',
				['2.png', '3.png', '1.png', '4.png', '5.png', '6.png', '7.png', '8.png', '9.png', '10.png', '11.png'], null,
				{
			...
			break;
			case "numberLine":
			this.addNumberLine(false);
			break;
			case "thermometer":
			this.addThermometer(false);
			break;
			case "patternBlocks":
			this.addPatternBlocksPalette(false);
			break;
		}
	}
};
...
/**
 * Adds the IntegerCounter palette to the sidebar.
 */
 Sidebar.prototype.addIntegerCounterPaletteWhenNotSupport = function (expand) {
 	var lineTags = 'line lines connector connectors connection connections arrow arrows ';

 	var fns = [
 	this.createVertexTemplateEntry('text;html=1;fillColor=#ffffff;overflow=fill;rounded=0;rotatable=0;editable=0;aspect=fixed;', 55, 55,
 		`<div class="scene scene--card" style="width:100%;height:100%;">
 		<div class="counter-card-not-support btn-perform-counter red-color">
 		</div>
 		</div>
 		`, '', null, null, null, false, 'testKing', null, null,{
			src:STENCIL_PATH+"/counters/red.png",
			width :"50px",
			height:"50px"
		}),
		 ...
		 this.createVertexTemplateEntry('text;html=1;fillColor=#ffffff;overflow=fill;rounded=0;rotatable=0;editable=0;aspect=fixed;', 55, 55,
 		`<div class="scene scene--card" style="width:100%;height:100%;">
 		<div class="counter-card-not-support btn-perform-counter yellow-color">
 		</div>
 		</div>
 		`, '', null, null, null, false, 'testKing', null, null,{
			src:STENCIL_PATH+"/counters/yellow.png",
			width :"50px",
			height:"50px"
		}),
		 ...
		 this.createVertexTemplateEntry('text;html=1;fillColor=#ffffff;overflow=fill;rounded=0;rotatable=0;editable=0;aspect=fixed;', 55, 55,
 		`<div class="scene scene--card" style="width:100%;height:100%;">
 		<div class="counter-card-not-support btn-perform-counter purple-color">
 		</div>
 		</div>
 		`, '', null, null, null, false, 'testKing', null, null,{
			src:STENCIL_PATH+"/counters/purple.png",
			width :"50px",
			height:"50px"
		}),
		 ...
		 this.createVertexTemplateEntry('text;html=1;fillColor=#ffffff;overflow=fill;rounded=0;rotatable=0;editable=0;aspect=fixed;', 55, 55,
 		`<div class="scene scene--card" style="width:100%;height:100%;">
 		<div class="counter-card-not-support btn-perform-counter green-color">
 		</div>
 		</div>
 		`, '', null, null, null, false, 'testKing', null, null,{
			src:STENCIL_PATH+"/counters/green.png",
			width :"50px",
			height:"50px"
		})
 	];

 	this.addPaletteFunctions('integerCounters', '<div class="menu-item"><span>Counters</span></div>', (expand != null) ? expand : true, fns);
 };


 Sidebar.prototype.addIntegerCounterPalette = function (expand) {
 	var lineTags = 'line lines connector connectors connection connections arrow arrows ';

 	var fns = [
 	this.createVertexTemplateEntry('text;html=1;fillColor=#ffffff;overflow=fill;rounded=0;editable=0;rotatable=0', 55, 55,
 		`<div class="scene scene--card" style="width:100%;height:100%;">
 		<div class="counter-card btn-perform-counter">
 		...
 		`<div class="scene scene--card" style="width:100%;height:100%;">
 		<div class="counter-card btn-perform-counter">
 		<div class="card__face card__face--front yellow-color"></div>
 		<div class="card__face card__face--back red-color"></div>
 		</div>
 		</div>
 		`, '', null, null, null, false, 'testKing' , null, null,{
			src:STENCIL_PATH+"/counters/yellow.png",
		...
		`<div class="scene scene--card" style="width:100%;height:100%;">
		<div class="counter-card btn-perform-counter">
		<div class="card__face card__face--front purple-color"></div>
		<div class="card__face card__face--back green-color"></div>
		</div>
		</div>
		`, '', null, null, null, false, 'testKing', null, null,{
		   src:STENCIL_PATH+"/counters/purple.png",
 		...
 		`<div class="scene scene--card" style="width:100%;height:100%;">
 		<div class="counter-card btn-perform-counter">
 		<div class="card__face card__face--front green-color"></div>
 		<div class="card__face card__face--back purple-color"></div>
 		</div>
 		</div>
 		`, '', null, null, null, false, 'testKing' , null, null,{
			src:STENCIL_PATH+"/counters/green.png",
 ...
 //2019/07/04 gnguyen start add
 Sidebar.prototype.addClock=function (expand){
 	var fns =[
 	this.createVertexTemplateEntry('resizable=0;rotatable=0;editable=0;aspect=fixed;shape=clock;', 300, 300, '', ''),
 	];
 	this.addPaletteFunctions('Clock', '<div class="menu-item"><span>Clock</span></div>', (expand != null) ? expand : true, fns);
 }
 Sidebar.prototype.addThermometer=function (expand){
 	var fns =[
 	this.createVertexTemplateEntry('aspect=fixed;rotatable=0;shape=QUICKSCROLL;editable=0;', 250, 450, '', 'Thermometer'),
 	];
 	this.addPaletteFunctions('Thermometer', '<div class="menu-item"><span>Thermometer</span></div>', (expand != null) ? expand : true, fns);
 }
 //2019/07/04 gnguyen end add
//2019/06/19 gnguyen start add
Sidebar.prototype.addNumberLine=function (expand){
	var sb=this;
	var graph=sb.graph;
	var fns =[
	this.addEntry(null,function () {

		var cell = new mxCell(null, new mxGeometry(0, 0,490,180),
			'editable=0;resizable=0;rotatable=0;aspect=fixed;shape=numberline;Maximum=5;Minimum=-5;Interval=1');
		// if (cell.getGeometry().width<600) {
		// 	cell.getGeometry().width=600;
		// }
		cell.vertex = true;
		cell.identity="NumberLinePro";
		var footer=new mxCell(null, new mxGeometry(0, 90,600,90),"editable=0;deletable=0;movable=0;resizable=0;fillColor=white;rotatable=0;");
		footer.vertex=true;
		footer.connectable=false;


		var minimumLabel = graph.insertVertex(footer, null, 'Minimum',0.1, 0.5,0,0, 'deletable=0;movable=0;constituent=1;resizable=0;rotatable=0;editable=0', true);
		var minimum=graph.insertVertex(footer, null, '-5',0.15,0.4, 50, 25, 'deletable=0;movable=0;constituent=1;resizable=0;rotatable=0', true);
		minimum.identity="minimum";

		var interValLabel = graph.insertVertex(footer, null, 'Interval',0.3, 0.5,0,0, 'deletable=0;movable=0;constituent=1;resizable=0;rotatable=0;editable=0', true);
		var interVal=graph.insertVertex(footer, null, '1',0.35,0.4, 50, 25, 'deletable=0;movable=0;constituent=1;resizable=0;rotatable=0', true);
		interVal.identity="interVal";

		var maximumLabel = graph.insertVertex(footer, null, 'Maximum',0.5, 0.5,0,0, 'deletable=0;movable=0;constituent=1;resizable=0;rotatable=0;editable=0', true);
		var maximum=graph.insertVertex(footer, null, '5',0.55,0.4, 50, 25, 'deletable=0;movable=0;constituent=1;resizable=0;rotatable=0', true);
		maximum.identity="maximum";

		var build=new mxCell("Build", new mxGeometry(500,65,100,25),"deletable=0;movable=0;resizable=0;fillColor=#D7D7D7;constituent=1;rotatable=0;editable=0;");
		build.vertex=true;
		build.identity="build";
		build.connectable=false;
		footer.insert(build);
		cell.insert(footer);

		return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, 'Number LineNumber Line');
		// // footer.insert(decimals);
		// // footer.insert(fractions);
		// group.insert(footer);


		// return sb.createVertexTemplateFromCells([group], group.geometry.width, group.geometry.height, 'Number Line');
	})
	];
	this.addPaletteFunctions('Number Line', '<div class="menu-item"><span>Number Lines</span></div>', (expand != null) ? expand : true, fns);
} 
Sidebar.prototype.addCentimeterCubes=function (expand) {
	var sb=this;	
	var fns =[
	this.addEntry(null, function()
	{
		var cell = new mxCell(null, new mxGeometry(0, 0,44,44),
			'rotatable=0;editable=0;resizable=0;rotatable=0;aspect=fixed;verticalAlign=top;align=left;spacingTop=8;spacingLeft=2;spacingRight=12;shape=cube;size=5;direction=south;fontStyle=4;html=1;fillColor=#0033CC;');
		cell.vertex = true;
	...
	// 	var g=[];
	// 	for (var i = 0; i < 10; i++) {
	// 		var cell = new mxCell(null, new mxGeometry(0, i*30,30,30),
	// 			'verticalAlign=top;align=left;spacingTop=8;spacingLeft=2;spacingRight=12;shape=cube;size=5;direction=south;fontStyle=4;html=1;fillColor=#0033CC;');
	// 		cell.vertex = true;
	// 		g.push(cell);
	// 	}
	// 	var c=sb.graph.groupCells(null, 0,g);
	// 	var unGroup=new mxCell(null,new mxGeometry(0,0,30,30),'shape=image;editable=0;movable=0;html=1;vimageAspect=1;aspect=fixed;image='+pathRelative+'lib/images/un.png');
	// 	unGroup.vertex=true;
	// 	unGroup.geometry.relative = true;
	// 	unGroup.geometry.offset = new mxPoint(-30, c.geometry.height);
	// 	unGroup.identity="un-group";
	// 	c.insert(unGroup);
	// 	c.identity="Block3";
	// 	return sb.createVertexTemplateFromCells([c], c.geometry.width, c.geometry.height, 'Cube 2');
	// }),
	// this.addEntry(null,function () {
	// 	var g1=[];
	// 	for (var j = 0; j <10 ; j++) {
	// 		var g=[];
	// 		for (var i = 0; i < 10; i++) {
	// 			var cell = new mxCell(null, new mxGeometry(j*30, i*30,30,30),
	// 				'verticalAlign=top;align=left;spacingTop=8;spacingLeft=2;spacingRight=12;shape=cube;size=5;direction=south;fontStyle=4;html=1;fillColor=#0033CC');
	// 			cell.vertex = true;
	// 			g.push(cell);
	// 		}
	// 		g1.push(sb.graph.groupCells(null, 0,g));
	// 	}
	// 	var c=sb.graph.groupCells(null, 0,g1);
	// 	var unGroup=new mxCell(null,new mxGeometry(0,0,30,30),'shape=image;editable=0;movable=0;html=1;vimageAspect=1;aspect=fixed;image='+pathRelative+'lib/images/un.png');
	// 	unGroup.vertex=true;
	// 	unGroup.geometry.relative = true;
	// 	unGroup.geometry.offset = new mxPoint(-30, c.geometry.height);
	...
	// 	c.insert(unGroup);
	// 	c.identity="Block3";
	// 	return sb.createVertexTemplateFromCells([c], c.geometry.width, c.geometry.height, 'Cube 3');
	// })
	]
	this.addPaletteFunctions('Centimeter Cubes', '<div class="menu-item"><span>Centimeter Cubes</span></div>', (expand != null) ? expand : true, fns);
}
Sidebar.prototype.addBaseTenBlock=function (expand) {
	var sb=this;	
	var fns =[
	this.addEntry(null, function()
	{
		var cell = new mxCell(null, new mxGeometry(0, 0,30,30),
			'rotatable=0;editable=0;resizable=0;aspect=fixed;verticalAlign=top;align=left;spacingTop=8;spacingLeft=2;spacingRight=12;shape=cube;size=5;direction=south;fontStyle=4;html=1;fillColor=#FFFF33;');
		cell.vertex = true;
		return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, '',null,null,null,null,
			{
				src:STENCIL_PATH+"/baseTenBlocks/b1.png",
				width :"25px",
				height:"25px"
			});
	}),
	this.addEntry(null,function () {
		var g=[];
		for (var i = 0; i < 10; i++) {
			var cell = new mxCell(null, new mxGeometry(60, i*26,30,30),
				'rotatable=0;editable=0;resizable=0;aspect=fixed;verticalAlign=top;align=left;spacingTop=8;spacingLeft=2;spacingRight=12;shape=cube;size=5;direction=south;fontStyle=4;html=1;fillColor=#FFFF33;');
			cell.vertex = true;
			g.push(cell);
		}
		var c=sb.graph.groupCells(null, 0,g.reverse());
		var unGroup=new mxCell(null,new mxGeometry(0,0,30,30),'shape=image;editable=0;rotatable=0;movable=0;html=1;vimageAspect=1;aspect=fixed;image='+pathRelative+'lib/images/un.png');
		unGroup.vertex=true;
		unGroup.geometry.relative = true;
		unGroup.geometry.offset = new mxPoint(-30, c.geometry.height);
		unGroup.identity="un-group";
		c.insert(unGroup);
		c.setStyle("rotatable=0;editable=0;resizable=0;group");
		return sb.createVertexTemplateFromCells([c], c.geometry.width, c.geometry.height, '',null,null,null,null,
			{
				src:STENCIL_PATH+"/baseTenBlocks/b2.png",
				width :"25px",
				height:"110px"
			});
	}),
	this.addEntry(null,function () {
		...
		for (var j = 0; j <10 ; j++) {
			var g=[];
			for (var i = 0; i < 10; i++) {
				var cell = new mxCell(null, new mxGeometry(j*26, i*26,30,30),
					'rotatable=0;editable=0;resizable=0;aspect=fixed;verticalAlign=top;align=left;spacingTop=8;spacingLeft=2;spacingRight=12;shape=cube;size=5;direction=south;fontStyle=4;html=1;fillColor=#FFFF33');
				cell.vertex = true;
				g.push(cell);
			}
			var t1=sb.graph.groupCells(null, 0,g.reverse());
			t1.setStyle("rotatable=0;editable=0;resizable=0;group");
			g1.push(t1);
			
		}
		var c=sb.graph.groupCells(null, 0,g1);

		var unGroup=new mxCell(null,new mxGeometry(0,0,30,30),'shape=image;rotatable=0;editable=0;movable=0;html=1;vimageAspect=1;aspect=fixed;image='+pathRelative+'lib/images/un.png');
		unGroup.vertex=true;
		unGroup.geometry.relative = true;
		unGroup.geometry.offset = new mxPoint(-30, c.geometry.height);
		unGroup.identity="un-group";
		...
		return sb.createVertexTemplateFromCells([c], c.geometry.width, c.geometry.height, '',null,null,null,null,
			{
				src:STENCIL_PATH+"/baseTenBlocks/b3.png",
				width :"110px",
				height:"110px"
			});
	}),
	this.addEntry(null,function () {
		var g2=[];
		var cell = new mxCell(null, new mxGeometry(0,0,30,30),
			'editable=0;rotatable=0;resizable=0;aspect=fixed;verticalAlign=top;align=left;spacingTop=8;spacingLeft=2;spacingRight=12;shape=cube;size=5;direction=south;fontStyle=4;html=1;fillColor=#FFFF33');
		cell.vertex = true;
		var clone=null;
		for (var h = 0; h < 10; h++) {
			var g1=[];
			for (var j = 0; j <10 ; j++) {
				...
				for (var i = 0; i < 10; i++) {
					clone=cell.clone();
					clone.geometry.x=j*26-h*5;
					clone.geometry.y=i*26+h*5;
					g.push(clone);
				}
				var t1=sb.graph.groupCells(null, 0,g.reverse());
				t1.setStyle("rotatable=0;editable=0;resizable=0;group");
			...
			var t2=sb.graph.groupCells(null, 0,g1);
			t2.setStyle("rotatable=0;editable=0;resizable=0;group");
			g2.push(t2);
		}
		var c=sb.graph.groupCells(null, 0,g2);
		var unGroup=new mxCell(null,new mxGeometry(0,0,30,30),'rotatable=0;editable=0;shape=image;editable=0;movable=0;html=1;vimageAspect=1;aspect=fixed;image='+pathRelative+'lib/images/un.png');
		unGroup.vertex=true;
		unGroup.geometry.relative = true;
		unGroup.geometry.offset = new mxPoint(-30, c.geometry.height);
		unGroup.identity="un-group";
		...
		return sb.createVertexTemplateFromCells([c], c.geometry.width, c.geometry.height, '',null,null,null,null,
			{
				src:STENCIL_PATH+"/baseTenBlocks/b4.png",
				width :"150px",
				height:"150px"
			});
	})
	]
	this.addPaletteFunctions('baseTenBlock', '<div class="menu-item"><span>Base Ten Blocks</span></div>', (expand != null) ? expand : true, fns);
}
//2019/06/19 gnguyen end add
/**
 * Adds the PatternBlocks palette to the sidebar.
 */
 Sidebar.prototype.addPatternBlocksPalette = function (expand) {
 	var lineTags = 'line lines connector connectors connection connections arrow arrows ';

 	var fns = [
 	this.createVertexTemplateEntry('whiteSpace=wrap;editable=0;html=1;aspect=fixed;fillColor=#FF8543', 120, 120, '', '', null, null, 'square'),
 	this.createVertexTemplateEntry('shape=parallelogram;editable=0;aspect=fixed;perimeter=parallelogramPerimeter;whiteSpace=wrap;size=0.3;html=1;fillColor=#4357FF', 180, 90, '', ''),
 	this.createVertexTemplateEntry('shape=trapezoid;aspect=fixed;editable=0;perimeter=trapezoidPerimeter;whiteSpace=wrap;html=1;fillColor=#FE4847', 180, 90, '', ''),
 	this.createVertexTemplateEntry('shape=hexagon;aspect=fixed;editable=0;perimeter=hexagonPerimeter2;whiteSpace=wrap;html=1;fillColor=#FDFD48', 180, 150, '', '', null, null, 'hexagon preparation'),
 	this.createVertexTemplateEntry('triangle;rotation=-90;aspect=fixed;editable=0;whiteSpace=wrap;html=1;fillColor=#23DE88', Math.cos(Math.PI/6) * 160, 160, '', '', null, null, 'triangle logic inverter buffer'),
 	this.createVertexTemplateEntry('shape=parallelogram;aspect=fixed;editable=0;size=0.5;perimeter=parallelogramPerimeter;whiteSpace=wrap;html=1;fillColor=#C9AC8A', 180, 90, '', ''),
 	];

 	this.addPaletteFunctions('patternblocks', '<div class="menu-item"><span>Pattern Blocks</span></div>', (expand != null) ? expand : true, fns);
 };
/**
 * Adds the Albera titles palette to the sidebar.
 */
 Sidebar.prototype.addAlberaTitlesPalette = function (expand) {
 	var lineTags = 'line lines connector connectors connection connections arrow arrows ';

 	var fns = [
 	this.createVertexTemplateEntry('html=1;whiteSpace=wrap;aspect=fixed;fontFamily=Comic Sans MS;fontStyle=1;fillColor=#D13433;resizable=0;rotatable=0;', 160, 160, `<span style="font-size:${160 * 0.5}px;font-height:bold;">-x<sup>2</sup></span>`, '', true, null, 'comic rectangle rect box text retro',false, 'algebra'),
 	this.createVertexTemplateEntry('html=1;whiteSpace=wrap;aspect=fixed;fontFamily=Comic Sans MS;fontStyle=1;fillColor=#6DB0CE;resizable=0;rotatable=0;', 160, 160, `<span style="font-size:${160 * 0.5}px;font-height:bold;">x<sup>2</sup> </span>`, '', true, null, 'comic rectangle rect box text retro',false, 'algebra'),
 	this.createVertexTemplateEntry('html=1;whiteSpace=wrap;aspect=fixed;fontFamily=Comic Sans MS;fontStyle=1;fillColor=#2C883E;resizable=0;rotatable=0;', 160, 40, `<span style="font-size:${40 * 0.5}px;font-height:bold;">x</span>`, '', true, null, 'comic rectangle rect box text retro',false, 'algebra'),
 	this.createVertexTemplateEntry('html=1;whiteSpace=wrap;aspect=fixed;fontFamily=Comic Sans MS;fontStyle=1;fillColor=#D13433;resizable=0;rotatable=0;', 160, 40, `<span style="font-size:${40 * 0.5}px;font-height:bold;">-x</span>`, '', true, null, 'comic rectangle rect box text retro',false, 'algebra'),
 	this.createVertexTemplateEntry('html=1;whiteSpace=wrap;aspect=fixed;fontFamily=Comic Sans MS;fontStyle=1;fillColor=yellow;resizable=0;rotatable=0;', 40, 40, `<span style="font-size:${40 * 0.5}px;font-height:bold;">1</span>`, '', true, null, 'comic rectangle rect box text retro',false, 'algebra'),
 	this.createVertexTemplateEntry('html=1;whiteSpace=wrap;aspect=fixed;fontFamily=Comic Sans MS;fontStyle=1;fillColor=#D13433;resizable=0;rotatable=0;', 40, 40, `<span style="font-size:${40 * 0.5}px;font-height:bold;">-1</span>`, '', true, null, 'comic rectangle rect box text retro',false, 'algebra'),
 	];

 	this.addPaletteFunctions('alberaTitles', '<div class="menu-item"><span>Algebra Tiles</span></div>', (expand != null) ? expand : true, fns);
 };
/**
 * Adds the Attribute blocks palette to the sidebar.
 */
 Sidebar.prototype.addAttributeBlocksPalette = function (expand) {
 	var lineTags = 'line lines connector connectors connection connections arrow arrows ';

 	var fns = [
 	this.createVertexTemplateEntry('triangle;editable=0;rotation=-90;aspect=fixed;whiteSpace=wrap;html=1;fillColor=#FDFD48;', Math.cos(Math.PI / 6) * 120, 120, '', '', null, null, 'triangle logic inverter buffer'),
 	this.createVertexTemplateEntry('shape=hexagon;editable=0;aspect=fixed;perimeter=hexagonPerimeter2;whiteSpace=wrap;html=1;fillColor=#FDFD48', 120, 100, '', '', null, null, 'hexagon preparation'),
 	this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;editable=0;html=1;aspect=fixed;fillColor=#FDFD48;', 120, 120, '', '', null, null, ''),
 	this.createVertexTemplateEntry('whiteSpace=wrap;html=1;aspect=fixed;editable=0;fillColor=#FDFD48;', 120, 120, '', '', null, null, 'square'),
 	this.createVertexTemplateEntry('whiteSpace=wrap;html=1;aspect=fixed;editable=0;fillColor=#FDFD48;', 50, 120, '', '', null, null, 'square'),
 	];

 	this.addPaletteFunctions('Attributeblocks', '<div class="menu-item"><span>Attribute Blocks</span></div>', (expand != null) ? expand : true, fns);
 };

 Sidebar.prototype.addNumberCubesPalette = function (expand) {
 	var lineTags = 'line lines connector connectors connection connections arrow arrows ';

 	var fns = [
 	this.createVertexTemplateEntry('text;html=1;fillColor=#ffffff;overflow=fill;rounded=0;editable=0;aspect=fixed;', 250, 250,
 		`
 		<section class="container" class="number-cube">
 		<div id="cube">
 		<figure class="uno">1</figure>
 		<figure class="dos">2</figure>
 		<figure class="tres">3</figure>
 		<figure class="cuatro">4</figure>
 		<figure class="cinco">5</figure>
 		<figure class="seis">6</figure>
 		</div>
 		</section>

 		<button onclick="roll()" class="btn-test">ROLL ME</button>
 		`, '', null, null, null, false, 'testKing')
 	];

 	this.addPaletteFunctions('Number cubes', '<div class="menu-item"><span>Number Cubes</span></div>', (expand != null) ? expand : true, fns);
 };
 ...
 */
 ...
 Sidebar.prototype.addFractionTilePalette = function(expand)
 {
 	this.addPaletteFunctions('FractionTile', '<div class="menu-item"><span>Fraction Tiles</span></div>', (expand != null) ? expand : false, this.createFractionTileShape());
 };

 Sidebar.prototype.addConnectingCubesPalette = function(expand)
 {
 	this.addPaletteFunctions('ConnectingCubes', '<div class="menu-item"><span>Connecting Cubes</span></div>', (expand != null) ? expand : false, this.createConnectingCubesShape());
 };
 Sidebar.prototype.addFractionCirclePalette = function(expand)
 {
 	this.addPaletteFunctions('FractionCircle', '<div class="menu-item"><span>Fraction Circles</span></div>', (expand != null) ? expand : false, this.createFractionCircleShape());
 };
 Sidebar.prototype.createFractionCircleShape = function()
 {
 	var sb = this;
 	var field = new mxCell('', new mxGeometry(10, 10, 160, 160), 'shape=KingTest;aspect=fixed;fillColor=#64AA50;perimeter=stepPerimeter;align=center;fixedSize=1;marginTop=20;points=[];resizable=0');
 	field.vertex = true;
 	return [
 	this.addEntry('list group erd table', function()
 	{
 		var cell = new mxCell('', new mxGeometry(0, 0, 180, 180),
 			'html=1;whiteSpace=wrap;container=1;recursiveResize=0;collapsible=0;');
 		cell.vertex = true;
 		cell.insert(sb.cloneCell(field, ''));
 		cell.identity = 'fraction-pieces';
 		return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, '');
 	}),
 	this.createVertexTemplateEntry('shape=CirclePieces;aspect=fixed;fillColor=#64AA50;perimeter=stepPerimeter;align=center;fixedSize=1;marginTop=20;points=[];resizable=0;', 80, 160, '1', '', null, null, 'circle one'),
 	];
 }

 Sidebar.prototype.createFractionTileShape = function()
 {
 	var sb = this;
 	var fractionContainerWidth = 500;
 	var fractionContainerHeight = 120;
 	return [
 	this.addEntry('list group erd table', function()
 	{
 		var cell = new mxCell('<span class="fraction-title">Fraction Tile Container</span>', new mxGeometry(0, 0, fractionContainerWidth, fractionContainerHeight),
 			'html=1;swimlane;fontStyle=0;childLayout=stackLayout;horizontal=1;startSize=40;fillColor=none;horizontalStack=1;' +
 			'resizeParent=0;resizeParentMax=0;resizeLast=0;collapsible=1;marginBottom=0;;editable=0;shadow=1;collapsible=0;rotatable=0');
 		cell.vertex = true;
 		cell.identity = "FractionTileParent";
 		return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, 'Container');
 	}),
 	this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;fontColor=white;rotatable=0;fontFamily=Comic Sans MS;fontStyle=1;fontSize=28;fontWeight=bold;html=1;fillColor=red;editable=0;resizable=0', fractionContainerWidth, fractionContainerHeight - 40, '1', '', null, null, 'rect rectangle box', false, 'FractionTile'),
 	this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;fontColor=white;rotatable=0;fontFamily=Comic Sans MS;fontStyle=1;fontSize=28;fontWeight=bold;html=1;fillColor=#873838;editable=0;resizable=0', fractionContainerWidth * (1/2), fractionContainerHeight - 40, '<span class="f"><div class="n">1</div><div class="d">2</div></span>', '', null, null, 'rect rectangle box', false, 'FractionTile'),
 	this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;fontColor=white;rotatable=0;fontFamily=Comic Sans MS;fontStyle=1;fontSize=12;html=1;fillColor=#282828;editable=0;resizable=0', fractionContainerWidth * (1/3), fractionContainerHeight - 40, '<span class="f"><div class="n">1</div><div class="d">3</div></span>', '', null, null, 'rect rectangle box', false, 'FractionTile'),
 	this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;fontColor=white;rotatable=0;fontFamily=Comic Sans MS;fontStyle=1;fontSize=12;html=1;fillColor=#F7E85C;editable=0;resizable=0', fractionContainerWidth * (1/4), fractionContainerHeight - 40, '<span class="f"><div class="n">1</div><div class="d">4</div></span>', '', null, null, 'rect rectangle box', false, 'FractionTile'),
 	this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;fontColor=white;rotatable=0;fontFamily=Comic Sans MS;fontStyle=1;fontSize=12;html=1;fillColor=#48CC74;editable=0;resizable=0', fractionContainerWidth * (1/5), fractionContainerHeight - 40, '<span class="f"><div class="n">1</div><div class="d">5</div></span>', '', null, null, 'rect rectangle box', false, 'FractionTile'),
 	this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;fontColor=white;rotatable=0;fontFamily=Comic Sans MS;fontStyle=1;fontSize=12;html=1;fillColor=#F98B38;editable=0;resizable=0', fractionContainerWidth * (1/6), fractionContainerHeight - 40, '<span class="f"><div class="n">1</div><div class="d">6</div></span>', '', null, null, 'rect rectangle box', false, 'FractionTile'),
 	this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;fontColor=white;rotatable=0;fontFamily=Comic Sans MS;fontStyle=1;fontSize=12;html=1;fillColor=#DD4050;editable=0;resizable=0', fractionContainerWidth * (1/8), fractionContainerHeight - 40, '<span class="f"><div class="n">1</div><div class="d">8</div></span>', '', null, null, 'rect rectangle box', false, 'FractionTile'),
 	this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;fontColor=white;rotatable=0;fontFamily=Comic Sans MS;fontStyle=1;fontSize=12;html=1;fillColor=#823D84;editable=0;resizable=0', fractionContainerWidth * (1/10), fractionContainerHeight - 40, '<span class="f"><div class="n">1</div><div class="d">10</div></span>', '', null, null, 'rect rectangle box', false, 'FractionTile'),
 	this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;fontColor=white;rotatable=0;fontFamily=Comic Sans MS;fontStyle=1;fontSize=12;html=1;fillColor=#D3487E;editable=0;resizable=0', fractionContainerWidth * (1/12), fractionContainerHeight - 40, '<span class="f"><div class="n">1</div><div class="d">12</div></span>', '', null, null, 'rect rectangle box', false, 'FractionTile')
 	];
 }
 Sidebar.prototype.createConnectingCubesShape = function()
 {
 	var sb = this;
 	var field = new mxCell('', new mxGeometry(0, 0, 80, 32), 'shape=umlFrame;editable=0;rotatable=0;deletable=0;fillColor=#64AA50;perimeter=stepPerimeter;fixedSize=1;points=[];resizable=0;');
 	field.vertex = true;
 	field.identity = "cube-child";
 	var field1 = new mxCell('', new mxGeometry(0, 0, 80, 32), 'shape=umlFrame;editable=0;rotatable=0;deletable=0;fillColor=#7E21AE;perimeter=stepPerimeter;fixedSize=1;points=[];resizable=0');
 	field1.vertex = true;
 	field1.identity = "cube-child";
 	var field2 = new mxCell('', new mxGeometry(0, 0, 80, 32), 'shape=umlFrame;editable=0;rotatable=0;deletable=0;fillColor=#C81E1E;perimeter=stepPerimeter;fixedSize=1;points=[];resizable=0');
 	field2.vertex = true;
 	field2.identity = "cube-child";
 	var field3 = new mxCell('', new mxGeometry(0, 0, 80, 32), 'shape=umlFrame;editable=0;rotatable=0;deletable=0;fillColor=yellow;perimeter=stepPerimeter;fixedSize=1;points=[];resizable=0');
 	field3.vertex = true;
 	field3.identity = "cube-child";
 	return [
 	this.addEntry('list group erd table', function()
 	{
 		var cell = new mxCell('', new mxGeometry(0, 0, 400, 80),
 			'childLayout=stackLayout;horizontal=1;rotatable=0;fillColor=none;horizontalStack=1;resizeParent=1;resizeParentMax=0;resizeLast=0;collapsible=0;strokeColor=none;stackBorder=10;stackSpacing=-12;resizable=1;align=center;points=[];fontColor=#000000;');
 		cell.vertex = true;
 		cell.insert(sb.cloneCell(field, ''));
 		cell.identity = 'cube-fraction';
 		return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, '');
 	}),this.addEntry('list group erd table', function()
 	{
 		var cell = new mxCell('', new mxGeometry(0, 0, 400, 80),
 			'childLayout=stackLayout;horizontal=1;rotatable=0;fillColor=none;horizontalStack=1;resizeParent=1;resizeParentMax=0;resizeLast=0;collapsible=0;strokeColor=none;stackBorder=10;stackSpacing=-12;resizable=1;align=center;points=[];fontColor=#000000;');
 		cell.vertex = true;
 		cell.insert(sb.cloneCell(field1, ''));
 		cell.identity = 'cube-fraction';
 		return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, '');
 	}),
 	this.addEntry('list group erd table', function()
 	...
 	this.addEntry('list group erd table', function()
 	{
 		var cell = new mxCell('', new mxGeometry(0, 0, 400, 80),
 			'childLayout=stackLayout;horizontal=1;rotatable=0;fillColor=none;horizontalStack=1;resizeParent=1;resizeParentMax=0;resizeLast=0;collapsible=0;strokeColor=none;stackBorder=10;stackSpacing=-12;resizable=1;align=center;points=[];fontColor=#000000;');
 		cell.vertex = true;
 		cell.insert(sb.cloneCell(field3, ''));
 		cell.identity = 'cube-fraction';
 		return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, '');
 	})
 	];
 ...
 */
 Sidebar.prototype.createAdvancedShapes = function()
 {
	...
	{
		var cell = new mxCell('List', new mxGeometry(0, 0, 140, 110),
			'swimlane;fontStyle=0;childLayout=flowLayout;');
		cell.vertex = true;
		cell.insert(sb.cloneCell(field, 'Item 1'));
		cell.insert(sb.cloneCell(field, 'Item 2'));
		cell.insert(sb.cloneCell(field, 'Item 3'));
 ...
 */
 Sidebar.prototype.createItem = function(cells, title, showLabel, showTitle, width, height, allowCellsInserted,isBackground,imageSideBar)
 {
 	var elt = document.createElement('a');
 	elt.className = 'geItem';
 	elt.style.overflow = 'hidden';
 	elt.setAttribute("isBackground",isBackground);
	...
	if (typeof imageSideBar!== "undefined"&& imageSideBar!=null) {
		var img=document.createElement("IMG");
		img.src=imageSideBar.src;
		img.style.width=imageSideBar.width;
		img.style.height=imageSideBar.height;
		elt.style.width=imageSideBar.width;
		elt.style.height=imageSideBar.height;
		elt.append(img);
	}
	else{
...
$(document).on('touchmove', function() {
 ...
 function setIntegerCounterFlipEvent(){
 	var isSafari = /^((?!chrome|android).)*safari/i.test(navigator.userAgent);
 	if ($('.scene').parent().length > 0) {
		$(".btn-perform-counter").off('click.perform touchend');
 		$(".btn-perform-counter").on('click.perform touchend', function (e) {
			 debugger;
			if (e.type == "click") {
			...
			if (detectTap){
				if(!isSafari){
					var integerCounter = this;
					$(integerCounter).toggleClass('is-flipped');
				} else {
					var integerCounterFace = $(this);
					if($(integerCounterFace).hasClass('red-color')) {
						$(integerCounterFace).removeClass('red-color');
						$(integerCounterFace).addClass('yellow-color');
					} else if($(integerCounterFace).hasClass('yellow-color')) {
						$(integerCounterFace).removeClass('yellow-color');
						$(integerCounterFace).addClass('red-color');
					} else if($(integerCounterFace).hasClass('purple-color')) {
						$(integerCounterFace).removeClass('purple-color');
						$(integerCounterFace).addClass('green-color');
					} else if($(integerCounterFace).hasClass('green-color')){
						$(integerCounterFace).removeClass('green-color');
						$(integerCounterFace).addClass('purple-color');
					}
				}
				e.stopPropagation();
 ...
 */
 Sidebar.prototype.addClickHandler = function(elt, ds, cells)
 {
 	...
 	{
 		if ($(elt).attr('isBackground')==="true") {
 			var url=$(elt).find('image').attr('xlink:href');
 			var ps=graph.getPageSize();
 			var img=new mxImage(url,ps.width,ps.height);
 ...
 * Creates a drop handler for inserting the given cells.
 */
 Sidebar.prototype.createVertexTemplateEntry = function(style, width, height, value, title, showLabel, showTitle, tags,isBackground=false,id=null, image = '',imageOpposite = '', imageSideBar = null)
 {
 	...
 	return this.addEntry(tags, mxUtils.bind(this, function()
 	{
 		...
 		return this.createVertexTemplate(style, width, height, value, title, showLabel, showTitle,null,isBackground,id, image, imageOpposite, imageSideBar);
 	}));
 }
 ...
 * Creates a drop handler for inserting the given cells.
 */
 Sidebar.prototype.createVertexTemplate = function(style, width, height, value, title, showLabel, showTitle, allowCellsInserted,isBackground,id,image = '', imageOpposite = '' , imageSideBar = null)
 {
 	...
 	if (id==="rule") {
 		...
 		cells[0].insert(symbol);
 	} else if(id === "money"){
 		// var symbol = new mxCell('', new mxGeometry(1,1,50,20), 'html=1;resizable=0;strokeColor=white;deletable=0;aspect=fixed;editable=0;cursor=pointer;movable=0;rotatable=0');
 		// symbol.identity = "TurnMoney";
 		// symbol.value= `<i class="fas fa-redo-alt btn-perform" title="Flip"></i>`;
 		// symbol.vertex = true;
 		// symbol.geometry.relative = true;
 		// symbol.geometry.offset = new mxPoint(-50, -20);
 		// symbol.image = image;
 		// symbol.imageOpposite = imageOpposite;
		//  cells[0].insert(symbol);
		cells[0].identity = "TurnMoney";
		cells[0].image = image;
 		cells[0].imageOpposite = imageOpposite;
 	} else if(id == "testKing") {
 		cells[0].identity = 'integerCounter';
 	} else if(id === "algebra") {
 		cells[0].identity = 'algebra';
 	} else if(id === "FractionTile"){
 		cells[0].identity = "FractionTile";
 	}
 	
 	return this.createVertexTemplateFromCells(cells, width, height, title, showLabel, showTitle, allowCellsInserted,isBackground, imageSideBar);
 };

/**
 * Creates a drop handler for inserting the given cells.
 */
 Sidebar.prototype.createVertexTemplateFromData = function(data, width, height, title, showLabel, showTitle, allowCellsInserted,isBackground)
 {
 	
 	var doc = mxUtils.parseXml(Graph.decompress(data));
 	console.log(Graph.decompress(data));
 	...
 	return this.createVertexTemplateFromCells(cells, width, height, title, showLabel, showTitle, allowCellsInserted,isBackground);
 };

/**
 * Creates a drop handler for inserting the given cells.
 */
 Sidebar.prototype.createVertexTemplateFromCells = function(cells, width, height, title, showLabel, showTitle, allowCellsInserted,isBackground,imageSideBar)
 {
	...
	return this.createItem(cells, title, showLabel, showTitle, width, height, allowCellsInserted,isBackground,imageSideBar);
};

/**
 * 
 */
 Sidebar.prototype.createEdgeTemplateEntry = function(style, width, height, value, title, showLabel, tags, allowCellsInserted,isBackground)
 {
 	tags = (tags != null && tags.length > 0) ? tags : title.toLowerCase();
 ...
 * Creates a drop handler for inserting the given cells.
 */
 Sidebar.prototype.createEdgeTemplate = function(style, width, height, value, title, showLabel, allowCellsInserted,isBackground)
 {
 	...
 	return this.createEdgeTemplateFromCells([cell], width, height, title, showLabel, allowCellsInserted,isBackground);
 };

/**
 * Creates a drop handler for inserting the given cells.
 */
 Sidebar.prototype.createEdgeTemplateFromCells = function(cells, width, height, title, showLabel, allowCellsInserted,isBackground)
 {	
 	return this.createItem(cells, title, showLabel, true, width, height, allowCellsInserted,null);
 };

/**
 * Adds the given palette.
 */
 Sidebar.prototype.addPaletteFunctions = function(id, title, expanded, fns, isBackground = false)
 {
 ...
 * Adds the given palette.
 */
 Sidebar.prototype.addPalette = function(id, title, expanded, onInit, isBackground = false)
 {
 	var divBound = document.createElement('div');
 	var elt = this.createTitle(title);
 	divBound.appendChild(elt);
 	if(isBackground === true){
 		divBound.classList.add('background-menu-item');
 	}
 	var div = document.createElement('div');
 	div.className = 'geSidebar';
    ...
    this.container.appendChild(divBound);
 ...
 */
 ...
 Sidebar.prototype.addBackground=function (id, title, prefix, postfix, items, titles, tags) {
 	var fns = [];
 	...
 	for (var i = 0; i < items.length; i++)
 	{
 		(mxUtils.bind(this, function(item, title, tmpTags)
 		{
 			...
 			fns.push(this.createVertexTemplateEntry('image;html=1;labelBackgroundColor=#ffffff;image=' + prefix + item + postfix,
 				this.defaultImageWidth, this.defaultImageHeight, '', title, title != null, null, this.filterTags(tmpTags),true));
 		}))(items[i], (titles != null) ? titles[i] : null, (tags != null) ? tags[items[i]] : null);
 	}
 	var isBackground = true;
 	this.addPaletteFunctions(id, title, false, fns, isBackground);
 }
/**
 ...
 */
 ...
 var versionImage = 1.2;
 Sidebar.prototype.addMoneyPalette = function(id, title, prefix, postfix, items, titles, tags)
 {
 	var showTitles = titles != null;
 	var fns = [];
 	...
 	for (var i = 0; i < items.length; i++)
 	{
 		(mxUtils.bind(this, function(item, title, tmpTags)
 		{
			 ...
			 var imageOpposite = splits[0] + '-opposite.' + splits[1];
			var moneyScaleRate = 1;
			if(item === "5.png"){
				moneyScaleRate = 1;
			} else if(item === "4.png") {
				moneyScaleRate = 0.9;
			...
			item = item + `?v=${versionImage}`;
			var ps=this.editorUi.editor.graph.getPageSize();
 			fns.push(this.createVertexTemplateEntry('image;html=1;editable=0;rotatable=0;aspect=fixed;labelBackgroundColor=#ffffff;image=' + prefix + item + postfix,
 				this.defaultImageWidth * 3 * moneyScaleRate, this.defaultImageHeight * 1.8 * moneyScaleRate, '', title, title != null, null, this.filterTags(tmpTags), false, "money",prefix + item + postfix, prefix + imageOpposite + postfix));
 		}))(items[i], (titles != null) ? titles[i] : null, (tags != null) ? tags[items[i]] : null);
 	}
 ...
 */
 Sidebar.prototype.addStencilPalette = function(id, title, stencilFile, style, ignore, onInit, scale, tags, customFns)
 {
 	...
 	if (this.addStencilsToIndex)
 	{
		...
		mxStencilRegistry.loadStencilSet(stencilFile, mxUtils.bind(this, function(packageName, stencilName, displayName, w, h,id)
		{
			if (ignore == null || mxUtils.indexOf(ignore, stencilName) < 0)
			{
				...
				var temp=this.createVertexTemplateEntry(
