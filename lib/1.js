		...
		if ($('.scene').length > 0) {
			$('.scene').click(function() {
				...
				$(".btn-perform").on('click.perform', function () {
					...
					// if($(integerCounter).hasClass('red-color')) {
					// 	$(integerCounter).addClass('yellow-color');
					// 	$(integerCounter).removeClass('red-color');
					// } else if($(integerCounter).hasClass('yellow-color')) {
					// 	$(integerCounter).addClass('red-color');
					// 	$(integerCounter).removeClass('yellow-color');
					// } else if($(integerCounter).hasClass('purple-color')){
					// 	$(integerCounter).addClass('green-color');
					// 	$(integerCounter).removeClass('purple-color');
					// } else if($(integerCounter).hasClass('green-color')){
					// 	$(integerCounter).addClass('purple-color');
					// 	$(integerCounter).removeClass('green-color');
					// }
				});
				clearInterval(timer);
				return;
