 ...
 */
 Sidebar.prototype.init = function()
 {
	...
	//  	';whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;strokeWidth=2');
	this.addBackground('Background','<img alt="Background" style="width:100%;height=100%;" src="'+pathRelative+'/lib/images/background.png"/>',dir+'/background/','',[
	...
	this.addAlberaTitlesPalette(false);
		...
		this.addMoneyPalette('money', '<img alt="Pattern blocks" style="width:100%;height=100%;" src="'+pathRelative+'/lib/images/money.png"/>', dir + '/moneys/', '',
 ...
 */
 Sidebar.prototype.addIntegerCounterPalette = function (expand) {
 	...
 	var fns = [
 	this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;fillColor=#DD4050;', 80, 80, '', 'Circle', null, null, 'circle'),
 	this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;fillColor=#F7E85C;', 80, 80, '', 'Circle', null, null, 'circle'),
 	this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;fillColor=#823D84', 80, 80, '', 'Circle', null, null, 'circle'),
 	this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;fillColor=#3EB763', 80, 80, '', 'Circle', null, null, 'circle'),

 	];

 	this.addPaletteFunctions('integerCounters', '<img alt="Integer counters" style="width:100%;height=100%;" src="'+pathRelative+'/lib/images/integerCounters.png"/>', (expand != null) ? expand : true, fns);
 };
 ...
 Sidebar.prototype.addClock=function (expand){
 	...
 	this.addPaletteFunctions('Clock', '<img alt="Clock" style="width:100%;height=100%;" src="'+pathRelative+'/lib/images/clockimg.png"/>', (expand != null) ? expand : true, fns);
 }
 Sidebar.prototype.addThermometer=function (expand){
 	...
 	this.addPaletteFunctions('Thermometer', '<img alt="Thermometer" style="width:100%;height=100%;" src="'+pathRelative+'/lib/images/thermometer.png"/>', (expand != null) ? expand : true, fns);
 }
...
Sidebar.prototype.addNumberLine=function (expand){
	...
	this.addPaletteFunctions('Number Line', '<img alt="Number line" style="width:100%;height=100%;" src="'+pathRelative+'/lib/images/numberline.png"/>', (expand != null) ? expand : true, fns);
} 
Sidebar.prototype.addCentimeterCubes=function (expand) {
	...
	this.addEntry(null,function () {
		...
		var unGroup=new mxCell(null,new mxGeometry(0,0,30,30),'shape=image;html=1;vimageAspect=1;aspect=fixed;image='+pathRelative+'lib/images/un.png');
		unGroup.vertex=true;
	...
	this.addPaletteFunctions('Centimeter Cubes', '<img alt="Centimeter cubes" style="width:100%;height=100%;" src="'+pathRelative+'/lib/images/centimetercubes.png"/>', (expand != null) ? expand : true, fns);
}
Sidebar.prototype.addBaseTenBlock=function (expand) {
	...
	{
		var cell = new mxCell(null, new mxGeometry(0, 0,30,30),
			'verticalAlign=top;align=left;spacingTop=8;spacingLeft=2;spacingRight=12;shape=cube;size=5;direction=south;fontStyle=4;html=1;fillColor=#D97C3D;');
		cell.vertex = true;
	...
	this.addEntry(null,function () {
		var g=[];
		for (var i = 0; i < 10; i++) {
			var cell = new mxCell(null, new mxGeometry(60, i*30,30,30),
				'verticalAlign=top;align=left;spacingTop=8;spacingLeft=2;spacingRight=12;shape=cube;size=5;direction=south;fontStyle=4;html=1;fillColor=#D97C3D;');
			cell.vertex = true;
			g.push(cell);
		}
	...
	this.addEntry(null,function () {
		...
		for (var h = 0; h < 10; h++) {
			...
			for (var j = 0; j <10 ; j++) {
				...
				for (var i = 0; i < 10; i++) {
					clone=cell.clone();
					clone.geometry.x=j*30+h*5;
					clone.geometry.y=i*30+h*5;
					g.push(clone);
				}
				g1.push(sb.graph.groupCells(null, 0,g));
			}
	...
	this.addPaletteFunctions('baseTenBlock', '<img alt="Base ten blocks" style="width:100%;height=100%;" src="'+pathRelative+'/lib/images/baseTenBlocks.png"/>', (expand != null) ? expand : true, fns);
}
//2019/06/19 gnguyen end add
/**
 ...
 */
 Sidebar.prototype.addPatternBlocksPalette = function (expand) {
 	...
 	var fns = [
 	this.createVertexTemplateEntry('whiteSpace=wrap;html=1;aspect=fixed;fillColor=#FF8543', 80, 80, '', 'Square', null, null, 'square'),
 	this.createVertexTemplateEntry('shape=parallelogram;perimeter=parallelogramPerimeter;whiteSpace=wrap;html=1;fillColor=#4357FF', 120, 60, '', 'Parallelogram'),
 	this.createVertexTemplateEntry('shape=trapezoid;perimeter=trapezoidPerimeter;whiteSpace=wrap;html=1;fillColor=#FE4847', 120, 60, '', 'Trapezoid'),
 	this.createVertexTemplateEntry('shape=hexagon;perimeter=hexagonPerimeter2;whiteSpace=wrap;html=1;fillColor=#FDFD48', 120, 80, '', 'Hexagon', null, null, 'hexagon preparation'),
 	this.createVertexTemplateEntry('triangle;whiteSpace=wrap;html=1;fillColor=#23DE88', 60, 80, '', 'Triangle', null, null, 'triangle logic inverter buffer'),

 	];

 	this.addPaletteFunctions('patternblocks', '<img alt="Pattern blocks" style="width:100%;height=100%;" src="'+pathRelative+'/lib/images/patternBlocks.png"/>', (expand != null) ? expand : true, fns);
 };
/**
 ...
 */
 Sidebar.prototype.addAlberaTitlesPalette = function (expand) {
 	...
 	this.addPaletteFunctions('alberaTitles', '<img alt="Algebra titles" style="width:100%;height=100%;" src="'+pathRelative+'/lib/images/algebraTitles.png"/>', (expand != null) ? expand : true, fns);
 };
/**
 ...
 */
 Sidebar.prototype.addAttributeBlocksPalette = function (expand) {
 	...
 	var fns = [
 	this.createVertexTemplateEntry('triangle;whiteSpace=wrap;html=1;fillColor=#FDFD48', 60, 80, '', 'Triangle', null, null, 'triangle logic inverter buffer'),
 	this.createVertexTemplateEntry('shape=hexagon;perimeter=hexagonPerimeter2;whiteSpace=wrap;html=1;fillColor=#FDFD48', 120, 80, '', 'Hexagon', null, null, 'hexagon preparation'),
 	this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;fillColor=#FDFD48;', 80, 80, '', 'Circle', null, null, 'circle'),
 	this.createVertexTemplateEntry('whiteSpace=wrap;html=1;aspect=fixed;fillColor=#FDFD48', 80, 80, '', 'Square', null, null, 'square'),
 	this.createVertexTemplateEntry('whiteSpace=wrap;html=1;aspect=fixed;fillColor=#FDFD48', 30, 80, '', 'Square', null, null, 'square'),
 	];

 	this.addPaletteFunctions('Attributeblocks', '<img alt="Pattern blocks" style="width:100%;height=100%;" src="'+pathRelative+'/lib/images/attributeBlocks.png"/>', (expand != null) ? expand : true, fns);
 };
...
Sidebar.prototype.addNumberCubesPalette = function (expand) {
	...
	var fns = [
	  ...
	  <button type="button" class="btn-perform"><i class="fas fa-object-ungroup"></i></button>
	  ...
	  <button type="button" class="btn-perform">Peform</button>
	  `, '', null, null, null, false, 'testKing'),
	  ...
	  <button type="button" class="btn-perform" onclick="alert('King');">Peform</button>
	  `, '', null, null, null, false, 'testKing'),
	...
	this.addPaletteFunctions('Number cubes', 'Number cubes', (expand != null) ? expand : true, fns);
};
 ...
 */
 ...
 {
 	this.addPaletteFunctions('FractionTile', '<img alt="Fraction tile container" style="width:100%;height=100%;" src="'+pathRelative+'/lib/images/fractiontilecontainer.png"/>', (expand != null) ? expand : false, this.createFractionTileShape());
 };

 Sidebar.prototype.addConnectingCubesPalette = function(expand)
 {
 	this.addPaletteFunctions('ConnectingCubes', '<img alt="Connecting cubes" style="width:100%;height=100%;" src="'+pathRelative+'/lib/images/connectingcubes.png"/>', (expand != null) ? expand : false, this.createConnectingCubesShape());
 };
 Sidebar.prototype.addFractionCirclePalette = function(expand)
 {
 	this.addPaletteFunctions('FractionCircle', '<img alt="Fraction circle container" style="width:100%;height=100%;" src="'+pathRelative+'/lib/images/fractioncirclecontainer.png"/>', (expand != null) ? expand : false, this.createFractionCircleShape());
 };
 ...
 * Creates a drop handler for inserting the given cells.
 */
 Sidebar.prototype.createVertexTemplateEntry = function(style, width, height, value, title, showLabel, showTitle, tags,isBackground=false,id=null, image = '')
 {
 	...
 	return this.addEntry(tags, mxUtils.bind(this, function()
 	{
 		...
 		return this.createVertexTemplate(style, width, height, value, title, showLabel, showTitle,null,isBackground,id, image);
 	}));
 }
 ...
 * Creates a drop handler for inserting the given cells.
 */
 Sidebar.prototype.createVertexTemplate = function(style, width, height, value, title, showLabel, showTitle, allowCellsInserted,isBackground,id,image = '')
 {
 	...
 	if (id==="rule") {
		...
		symbol.imageOpposite = splits[0] + '-opposite.' + splits[1]; 
		cells[0].insert(symbol);
	 } else if(id == "testKing") {
 	...
 	for (var i = 0; i < items.length; i++)
 	{
 		(mxUtils.bind(this, function(item, title, tmpTags)
 		{
 			...
 			fns.push(this.createVertexTemplateEntry('image;html=1;editable=0;labelBackgroundColor=#ffffff;image=' + prefix + item + postfix,
 				this.defaultImageWidth * 3, this.defaultImageHeight * 3, '', title, title != null, null, this.filterTags(tmpTags), false, "money",prefix + item + postfix));
 		}))(items[i], (titles != null) ? titles[i] : null, (tags != null) ? tags[items[i]] : null);
 	}
