...
Sidebar.prototype.addCentimeterCubes=function (expand) {
	...
	this.addEntry(null, function()
	{
		var cell = new mxCell(null, new mxGeometry(0, 0,44,44),
			'editable=0;resizable=0;rotatable=0;aspect=fixed;verticalAlign=top;align=left;spacingTop=8;spacingLeft=2;spacingRight=12;shape=cube;size=5;direction=south;fontStyle=4;html=1;fillColor=#0033CC;');
		cell.vertex = true;
...
Sidebar.prototype.addBaseTenBlock=function (expand) {
	...
	this.addEntry(null, function()
	{
		var cell = new mxCell(null, new mxGeometry(0, 0,30,30),
			'editable=0;resizable=0;aspect=fixed;verticalAlign=top;align=left;spacingTop=8;spacingLeft=2;spacingRight=12;shape=cube;size=5;direction=south;fontStyle=4;html=1;fillColor=#FFFF33;');
		cell.vertex = true;
	...
	this.addEntry(null,function () {
		...
		unGroup.identity="un-group";
		c.insert(unGroup);
		c.setStyle("editable=0;resizable=0;group");
	...
	this.addEntry(null,function () {
		...
		for (var j = 0; j <10 ; j++) {
			...
			t1.setStyle("editable=0;resizable=0;group");
			g1.push(t1);
	...
	this.addEntry(null,function () {
		...
		for (var h = 0; h < 10; h++) {
			...
			t2.setStyle("editable=0;resizable=0;group");
			g2.push(t2);
		}
		var c=sb.graph.groupCells(null, 0,g2);
		var unGroup=new mxCell(null,new mxGeometry(0,0,30,30),'editable=0;shape=image;editable=0;movable=0;html=1;vimageAspect=1;aspect=fixed;image='+pathRelative+'lib/images/un.png');
		unGroup.vertex=true;
		unGroup.geometry.relative = true;
		unGroup.geometry.offset = new mxPoint(-30, c.geometry.height);
		unGroup.identity="un-group";
