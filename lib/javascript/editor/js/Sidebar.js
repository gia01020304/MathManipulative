 ...
 */
 ...
 Sidebar.prototype.addClock=function (expand){
 	var fns =[
 	this.createVertexTemplateEntry('resizable=0;aspect=fixed;shape=clock;', 300, 300, '', 'Clock'),
 	];
 ...
 Sidebar.prototype.addThermometer=function (expand){
 	var fns =[
 	this.createVertexTemplateEntry('aspect=fixed;shape=QUICKSCROLL;', 250, 450, '', 'Thermometer'),
 	];
 ...
 */
 Sidebar.prototype.addPatternBlocksPalette = function (expand) {
 	...
 	var fns = [
 	this.createVertexTemplateEntry('whiteSpace=wrap;html=1;aspect=fixed;fillColor=#FF8543', 120, 120, '', 'Square', null, null, 'square'),
 	this.createVertexTemplateEntry('shape=parallelogram;aspect=fixed;perimeter=parallelogramPerimeter;whiteSpace=wrap;size=0.3;html=1;fillColor=#4357FF', 240, 120, '', 'Parallelogram 1'),
 	this.createVertexTemplateEntry('shape=trapezoid;aspect=fixed;perimeter=trapezoidPerimeter;whiteSpace=wrap;html=1;fillColor=#FE4847', 120, 60, '', 'Trapezoid'),
 	this.createVertexTemplateEntry('shape=hexagon;aspect=fixed;perimeter=hexagonPerimeter2;whiteSpace=wrap;html=1;fillColor=#FDFD48', 120, 100, '', 'Hexagon', null, null, 'hexagon preparation'),
 	this.createVertexTemplateEntry('triangle;rotation=-90;aspect=fixed;whiteSpace=wrap;html=1;fillColor=#23DE88', 120, 160, '', 'Triangle', null, null, 'triangle logic inverter buffer'),
 	this.createVertexTemplateEntry('shape=parallelogram;aspect=fixed;size=0.5;perimeter=parallelogramPerimeter;whiteSpace=wrap;html=1;fillColor=#C9AC8A', 240, 120, '', 'Parallelogram 2'),
 	];
 ...
 */
 Sidebar.prototype.addAttributeBlocksPalette = function (expand) {
 	...
 	var fns = [
 	this.createVertexTemplateEntry('triangle;rotation=-90;aspect=fixed;whiteSpace=wrap;html=1;fillColor=#FDFD48', 120, 160, '', 'Triangle', null, null, 'triangle logic inverter buffer'),
 	this.createVertexTemplateEntry('shape=hexagon;aspect=fixed;perimeter=hexagonPerimeter2;whiteSpace=wrap;html=1;fillColor=#FDFD48', 120, 100, '', 'Hexagon', null, null, 'hexagon preparation'),
 	this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;fillColor=#FDFD48;', 120, 120, '', 'Circle', null, null, 'circle'),
 	this.createVertexTemplateEntry('whiteSpace=wrap;html=1;aspect=fixed;fillColor=#FDFD48', 120, 120, '', 'Square', null, null, 'square'),
 	this.createVertexTemplateEntry('whiteSpace=wrap;html=1;aspect=fixed;fillColor=#FDFD48', 50, 120, '', 'Square', null, null, 'square'),
 	];
 ...
 */
 ...
 {
 	var sb = this;
 	var field = new mxCell('', new mxGeometry(0, 0, 80, 32), 'shape=umlFrame;editable=0;rotatable=0;fillColor=#64AA50;perimeter=stepPerimeter;fixedSize=1;points=[];resizable=0');
 	field.vertex = true;
 	var field1 = new mxCell('', new mxGeometry(0, 0, 80, 32), 'shape=umlFrame;editable=0;rotatable=0;fillColor=#7E21AE;perimeter=stepPerimeter;fixedSize=1;points=[];resizable=0');
 	field1.vertex = true;
 	var field2 = new mxCell('', new mxGeometry(0, 0, 80, 32), 'shape=umlFrame;editable=0;rotatable=0;fillColor=#C81E1E;perimeter=stepPerimeter;fixedSize=1;points=[];resizable=0');
 	field2.vertex = true;
 	var field3 = new mxCell('', new mxGeometry(0, 0, 80, 32), 'shape=umlFrame;editable=0;rotatable=0;fillColor=#C1C831;perimeter=stepPerimeter;fixedSize=1;points=[];resizable=0');
 	field3.vertex = true;
 	return [
 	this.addEntry('list group erd table', function()
 	{
 ...
 */
 Sidebar.prototype.createVertexTemplate = function(style, width, height, value, title, showLabel, showTitle, allowCellsInserted,isBackground,id,image = '', imageOpposite = '')
 {
 	...
 	if (id==="rule") {
		...
		var symbol = new mxCell('', new mxGeometry(1,1,50,20), 'resizable=0;aspect=fixed;editable=0;cursor=pointer;movable=0;rotatable=0');
