 ...
 */
 (function()
 {
 	...
 	RulerStandard.prototype.paintVertexShape= function(c, x, y, w, h){
 		...
 		c.setStrokeColor('black');
 		var value=0;
 		var step=Math.floor(widthRuler/15);
 		var step2=Math.floor(step/2);

 		for (var i = 0; i <=widthRuler; i+=step) {
 			c.moveTo(startRuler+i,0,'center');
 			c.lineTo(startRuler+i,h/3,'center');
 			c.setFontSize (15);
 			c.text(startRuler+i,h/3+5,0,0,value.toString(),'center');
 			value+=10;
 			if (value<=150) {
 				c.moveTo(startRuler+i+step2,0,'center');
 				c.lineTo(startRuler+i+step2,h/5,'center');
 			}
 		}
 		c.stroke();
 		c.end();
 	...
 	RulerMetric.prototype.paintVertexShape= function(c, x, y, w, h){
 		...
 		c.setStrokeColor('black');
 		var value=0;
 		var step=Math.floor(widthRuler/6);
 		var step2=Math.floor(step/4);
 		for (var i = 0; i <=widthRuler; i+=step) {
 			...
 			if (value<=6) {
 				...
 				c.moveTo(startRuler+i+step2*2,0,'center');
 				c.lineTo(startRuler+i+step2*2,h/4,'center');

 				c.moveTo(startRuler+i+step2*3,0,'center');
 				c.lineTo(startRuler+i+step2*3,h/5,'center');
 			}
 		}
 		c.stroke();
 		c.end();
