 ...
 */
 Sidebar.prototype.init = function()
 {
	...
	this.addBackground('Background','Background',dir+'/background/','',[
 ...
 */
 Sidebar.prototype.addAlberaTitlesPalette = function (expand) {
 	...
 	var fns = [
 	this.createVertexTemplateEntry('html=1;whiteSpace=wrap;aspect=fixed;fontFamily=Comic Sans MS;fontStyle=1;fillColor=#D13433;', 80, 80, '-x<sup>2</sup>', '', true, null, 'comic rectangle rect box text retro'),
 	this.createVertexTemplateEntry('html=1;whiteSpace=wrap;aspect=fixed;fontFamily=Comic Sans MS;fontStyle=1;fillColor=#6DB0CE;', 80, 80, 'x<sup>2</sup>', '', true, null, 'comic rectangle rect box text retro'),
 	this.createVertexTemplateEntry('html=1;whiteSpace=wrap;aspect=fixed;fontFamily=Comic Sans MS;fontStyle=1;fillColor=#2C883E;', 20, 80, 'x', '', true, null, 'comic rectangle rect box text retro'),
 	this.createVertexTemplateEntry('html=1;whiteSpace=wrap;aspect=fixed;fontFamily=Comic Sans MS;fontStyle=1;fillColor=#D13433;', 20, 80, '-x', '', true, null, 'comic rectangle rect box text retro'),
 	this.createVertexTemplateEntry('html=1;whiteSpace=wrap;aspect=fixed;fontFamily=Comic Sans MS;fontStyle=1;fillColor=#E4C564;', 30, 30, '1', '', true, null, 'comic rectangle rect box text retro'),
 	this.createVertexTemplateEntry('html=1;whiteSpace=wrap;aspect=fixed;fontFamily=Comic Sans MS;fontStyle=1;fillColor=#D13433;', 30, 30, '-1', '', true, null, 'comic rectangle rect box text retro'),
 	];

 	this.addPaletteFunctions('alberaTitles', '<div class="menu-item"><span>Algebra Titles</span></div>', (expand != null) ? expand : true, fns);
 };
/**
 ...
 */
 Sidebar.prototype.addAttributeBlocksPalette = function (expand) {
 	...
 	this.addPaletteFunctions('Attributeblocks', '<div class="menu-item"><span>Attribute Block</span></div>', (expand != null) ? expand : true, fns);
 };
 ...
 */
 ...
 {
 	this.addPaletteFunctions('FractionTile', '<div class="menu-item"><span>Fraction Tile Container</span></div>', (expand != null) ? expand : false, this.createFractionTileShape());
 };
 ...
 {
 	this.addPaletteFunctions('FractionCircle', '<div class="menu-item"><span>Fraction Circle</span></div>', (expand != null) ? expand : false, this.createFractionCircleShape());
 };
 ...
 Sidebar.prototype.createFractionTileShape = function()
 {
 	...
 	this.addEntry('list group erd table', function()
 	{
 		var cell = new mxCell('Fraction Tile Container', new mxGeometry(0, 0, 400, 80),
 			'swimlane;fontStyle=0;childLayout=stackLayout;horizontal=1;startSize=26;fillColor=none;horizontalStack=1;' +
 	...
 	this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;fontColor=white;fontFamily=Comic Sans MS;fontStyle=1;fontSize=12;html=1;fillColor=red;editable=0;resizable=0', 400, 60, '1', '', null, null, 'rect rectangle box'),
 	this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;fontColor=white;fontFamily=Comic Sans MS;fontStyle=1;fontSize=12;html=1;fillColor=#873838;editable=0;resizable=0', 400 * (1/2), 60, '<sup>1</sup>&frasl;<sub>2</sub>', '', null, null, 'rect rectangle box'),
 	this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;fontColor=white;fontFamily=Comic Sans MS;fontStyle=1;fontSize=12;html=1;fillColor=#282828;editable=0;resizable=0', 400 * (1/3), 60, '<sup>1</sup>&frasl;<sub>3</sub>', '', null, null, 'rect rectangle box'),
 	this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;fontColor=white;fontFamily=Comic Sans MS;fontStyle=1;fontSize=12;html=1;fillColor=#F7E85C;editable=0;resizable=0', 400 * (1/4), 60, '<sup>1</sup>&frasl;<sub>4</sub>', '', null, null, 'rect rectangle box'),
 	this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;fontColor=white;fontFamily=Comic Sans MS;fontStyle=1;fontSize=12;html=1;fillColor=#48CC74;editable=0;resizable=0', 400 * (1/5), 60, '<sup>1</sup>&frasl;<sub>5</sub>', '', null, null, 'rect rectangle box'),
 	this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;fontColor=white;fontFamily=Comic Sans MS;fontStyle=1;fontSize=12;html=1;fillColor=#F98B38;editable=0;resizable=0', 400 * (1/6), 60, '<sup>1</sup>&frasl;<sub>6</sub>', '', null, null, 'rect rectangle box'),
 	this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;fontColor=white;fontFamily=Comic Sans MS;fontStyle=1;fontSize=12;html=1;fillColor=#DD4050;editable=0;resizable=0', 400 * (1/8), 60, '<sup>1</sup>&frasl;<sub>8</sub>', '', null, null, 'rect rectangle box'),
 	this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;fontColor=white;fontFamily=Comic Sans MS;fontStyle=1;fontSize=12;html=1;fillColor=#823D84;editable=0;resizable=0', 400 * (1/10), 60, '<sup>1</sup>&frasl;<sub>10</sub>', '', null, null, 'rect rectangle box'),
 	this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;fontColor=white;fontFamily=Comic Sans MS;fontStyle=1;fontSize=12;html=1;fillColor=#D3487E;editable=0;resizable=0', 400 * (1/12), 60, '<sup>1</sup>&frasl;<sub>12</sub>', '', null, null, 'rect rectangle box')
 	];
 }
 Sidebar.prototype.createConnectingCubesShape = function()
 {
 	var sb = this;
 	var field = new mxCell('', new mxGeometry(0, 0, 80, 32), 'shape=umlFrame;fillColor=#64AA50;perimeter=stepPerimeter;fixedSize=1;points=[];resizable=0');
 	field.vertex = true;
 	var field1 = new mxCell('', new mxGeometry(0, 0, 80, 32), 'shape=umlFrame;fillColor=#7E21AE;perimeter=stepPerimeter;fixedSize=1;points=[];resizable=0');
 	field1.vertex = true;
 	var field2 = new mxCell('', new mxGeometry(0, 0, 80, 32), 'shape=umlFrame;fillColor=#C81E1E;perimeter=stepPerimeter;fixedSize=1;points=[];resizable=0');
 	field2.vertex = true;
 	var field3 = new mxCell('', new mxGeometry(0, 0, 80, 32), 'shape=umlFrame;fillColor=#C1C831;perimeter=stepPerimeter;fixedSize=1;points=[];resizable=0');
 	field3.vertex = true;
 	return [
 	this.addEntry('list group erd table', function()
 	{
 ...
 */
 ...
 Sidebar.prototype.addBackground=function (id, title, prefix, postfix, items, titles, tags) {
 	...
 	this.addPaletteFunctions(title, title, false, fns);
 }
/**
