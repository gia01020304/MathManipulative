 ...
 */
 Sidebar.prototype.init = function()
 {
	...
	';whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;strokeWidth=2');
	this.addStencilPalette('connectingcubes', 'Connecting cubes ', dir + '/cubeconnecting.xml',
	';whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;strokeWidth=2');
...
Sidebar.prototype.addNumberLine=function (expand){
	...
	this.addEntry(null,function () {
		...
		var numberLine=graph.insertVertex(group, null,null, 0, 0, 600, 100, 'aspect=fixed;shape=numberline;resizable=0;');
		...
		// var decimals=new mxCell("Decimals", new mxGeometry(0, 0,100,25),"fillColor=#D7D7D7;constituent=1;resizable=0;");

		// decimals.vertex=true;
		// decimals.geometry.relative = true;
		// decimals.connectable=false;

		// var fractions=new mxCell("Fractions", new mxGeometry(100,0,100,25),"fillColor=#D7D7D7;constituent=1;resizable=0;");
		// fractions.vertex=true;
		// fractions.connectable=false;
	...
	this.addPaletteFunctions('Number Line', 'Number Line', (expand != null) ? expand : true, fns);
} 
Sidebar.prototype.addCentimeterCubes=function (expand) {
	...
	this.addPaletteFunctions('Centimeter Cubes', 'Centimeter Cubes', (expand != null) ? expand : true, fns);
}
 ...
 */
 ...
 {
 	this.addPaletteFunctions('FractionTile', "Fraction Tile Container", (expand != null) ? expand : false, this.createFractionTileShape());
 };
