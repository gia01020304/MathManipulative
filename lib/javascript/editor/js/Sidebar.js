 ...
 */
 ...
 Sidebar.prototype.addClock=function (expand){
	...
	this.addPaletteFunctions('Clock', 'Clock', (expand != null) ? expand : true, fns);
 }
 ...
 */
 ...
 {
 	this.addPaletteFunctions('ConnectingCubes', 'Connecting Cubes', (expand != null) ? expand : false, this.createConnectingCubesShape());
 };
 Sidebar.prototype.addFractionCirclePalette = function(expand)
 {
 	this.addPaletteFunctions('FractionCircle', 'Fraction Circle', (expand != null) ? expand : false, this.createFractionCircleShape());
 };
