 ...
 */
 Sidebar.prototype.addIntegerCounterPaletteWhenNotSupport = function (expand) {
 	...
 	var fns = [
 	this.createVertexTemplateEntry('text;html=1;fillColor=#ffffff;overflow=fill;rounded=0;editable=0;aspect=fixed;', 55, 55,
 ...
 */
 ...
 function setIntegerCounterFlipEvent(){
 	...
 	if ($('.scene').parent().length > 0) {
 		$(".btn-perform-counter").off('click.perform touchmove');
 		$(".btn-perform-counter").on('click.perform touchmove', function (e) {
 			if(!isSafari){
