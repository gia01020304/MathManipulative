 ...
 */
 (function()
 {
 	...
 	RulerStandard.prototype.paintVertexShape= function(c, x, y, w, h){
 		...
 		c.setStrokeColor('black');
 		var value=0;
 		var step=Math.round(widthRuler/15);
 		...
 		c.setStrokeWidth(1);
 		c.setStrokeColor('black');
 		var step=widthRuler/30;
 		startRuler=20;
 		for (var i = 0; i <=widthRuler; i+=step) {
 			c.moveTo(startRuler+i,0);
 			c.lineTo(startRuler+i,h/4);
 		}
 		c.stroke();
 		c.end();
 		c.setFontSize (20);
 	...
 	RulerMetric.prototype.paintVertexShape= function(c, x, y, w, h){
 		...
 		c.setStrokeColor('black');
 		var value=0;
 		var step=Math.round(widthRuler/6);
 		for (var i = 0; i <=widthRuler; i+=step) {
 			c.moveTo(startRuler+i,0);
 			c.lineTo(startRuler+i,h/3);
 			c.setFontSize (15);
 		...
 		c.setStrokeWidth(1);
 		c.setStrokeColor('black');
 		var step=Math.round(widthRuler/24);

 		for (var i = 0; i <=widthRuler; i+=step) {
 			c.moveTo(startRuler+i,0);
 			c.lineTo(startRuler+i,h/5);
 			c.setFontSize (15);
 		}
 		c.stroke();
 		c.end();
 		...
 		c.setStrokeWidth(1);
 		c.setStrokeColor('black');
 		var step=Math.round(widthRuler/12);
