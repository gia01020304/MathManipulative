 ...
 */
 Sidebar.prototype.init = function()
 {
	...
	//  	';whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;strokeWidth=2');
	//<img alt="Background" style="width:100%;height=100%;" src="'+pathRelative+'/lib/images/background.png"/>
	this.addBackground('Backgrounds','Backgrounds',dir+'/background/','',[
		'blankCalendar.jpg','centimeterGrid.png','inchGrid.png','coordinateGrid.png','hundredChart.png','placeValueHundred.png','placeValueThousand.png','placeValueDecimals.png','tenFrame.png','inout.png', 'partpartwhole.png','numberLine1.png','numberLine2.png','numberLine3.png', 'numberLine4.png','bardiagram.png', 'geoboard.jpg'
		],["Blank Calendar", "Centimeter Grid", "Inch Grid" , "Coordinate Grid" , "Hundreds Chart", 'Place Value Chart (Hundreds)', 'Place Value Chart (Billions)', 'Place Value Chart (Decimals)', 'Ten Frames', 'In/Out Tables', 'Part Part Whole Chart', 'Number Line (0 - 30)', 'Number Line (31 - 60)', 'Number Line (61 - 100)', 'Number Line (Empty)', 'Bar Model', 'Geoboards'],null);
	...
	// this.addStencilPalette('cubenumbers', 'Number cubes ', dir + '/cubenumbers.xml',
	// ';whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;strokeWidth=2');
	// this.addStencilPalette('connectingcubes', '<img alt="Connecting cubes" style="width:100%;height=100%;" src="'+pathRelative+'/lib/images/connectingcubes.png"/>', dir + '/cubeconnecting.xml',
	// ';whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;strokeWidth=2');
	// this.addStencilPalette('thermometer', 'Thermometer ', dir + '/thermometer.xml',
	// ';whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;strokeWidth=2');
		// this.addImagePalette('baseTenBlocks', '<img alt="Base ten blocks" style="width:100%;height=100%;" src="'+pathRelative+'/lib/images/baseTenBlocks.png"/>', dir + '/baseTenBlocks/', '',
		// ['1.png','2.png','3.png','4.png'], null,
		// {'Wireless_Router_N': 'wireless router switch wap wifi access point wlan',
		// 'Router_Icon': 'router switch'});
		//2019/06/19 gnguyen start add
		//2019/06/19 gnguyen end add
		// this.addImagePalette('thermometer', '<img alt="Thermometer" style="width:100%;height=100%;" src="'+pathRelative+'/lib/images/thermometer.png"/>', dir + '/thermometer/', '',
		// 	['1.png'], null,
		// 	{'Wireless_Router_N': 'wireless router switch wap wifi access point wlan',
		// 	'Router_Icon': 'router switch'});
		// this.addImagePalette('patternBlocks', "Pattern Blocks", dir + '/patternBlocks/', '',
		// ['1.png','2.png','3.png','4.png','5.png','6.png'], null,
		// {'Wireless_Router_N': 'wireless router switch wap wifi access point wlan',
		// 'Router_Icon': 'router switch'});
		this.addPatternBlocksPalette(false);
		//this.addNumberCubesPalette(false);
 ...
 */
 Sidebar.prototype.addIntegerCounterPalette = function (expand) {
 	...
 	this.addPaletteFunctions('integerCounters', '<div class="menu-item"><span>Integer Counters</span></div>', (expand != null) ? expand : true, fns);
 };
 //2019/07/04 gnguyen start add
 Sidebar.prototype.addClock=function (expand){
 	var fns =[
 	this.createVertexTemplateEntry('resizable=0;editable=0;aspect=fixed;shape=clock;', 300, 300, '', 'Clock'),
 	];
...
Sidebar.prototype.addNumberLine=function (expand){
	...
	this.addEntry(null,function () {
		...
		var cell = new mxCell(null, new mxGeometry(0, 0,600,230),
			'editable=0;resizable=0;aspect=fixed;shape=numberline');
		cell.vertex = true;
		...
		return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, 'Number Line');
	...
	this.addPaletteFunctions('Number Line', '<div class="menu-item"><span>Number Line</span></div>', (expand != null) ? expand : true, fns);
} 
Sidebar.prototype.addCentimeterCubes=function (expand) {
	...
	this.addEntry(null, function()
	{
		...
		cell.vertex = true;
		return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, 'Cube');
	})
	// ,
	// this.addEntry(null,function () {
	// 	var g=[];
...
Sidebar.prototype.addBaseTenBlock=function (expand) {
	...
	this.addEntry(null,function () {
		...
		return sb.createVertexTemplateFromCells([c], c.geometry.width, c.geometry.height, 'Block 2');
	}),
	this.addEntry(null,function () {
		var g1=[];
		for (var j = 0; j <10 ; j++) {
	...
	this.addEntry(null,function () {
		...
		c.identity="Block4";
		return sb.createVertexTemplateFromCells([c], c.geometry.width, c.geometry.height, 'Block 3');
	})
	]
 ...
 */
 Sidebar.prototype.addPatternBlocksPalette = function (expand) {
 	...
 	var fns = [
 	this.createVertexTemplateEntry('whiteSpace=wrap;editable=0;html=1;aspect=fixed;fillColor=#FF8543', 120, 120, '', 'Square', null, null, 'square'),
 	this.createVertexTemplateEntry('shape=parallelogram;editable=0;aspect=fixed;perimeter=parallelogramPerimeter;whiteSpace=wrap;size=0.3;html=1;fillColor=#4357FF', 240, 120, '', 'Parallelogram 1'),
 	this.createVertexTemplateEntry('shape=trapezoid;aspect=fixed;editable=0;perimeter=trapezoidPerimeter;whiteSpace=wrap;html=1;fillColor=#FE4847', 120, 60, '', 'Trapezoid'),
 	this.createVertexTemplateEntry('shape=hexagon;aspect=fixed;editable=0;perimeter=hexagonPerimeter2;whiteSpace=wrap;html=1;fillColor=#FDFD48', 120, 100, '', 'Hexagon', null, null, 'hexagon preparation'),
 	this.createVertexTemplateEntry('triangle;rotation=-90;aspect=fixed;editable=0;whiteSpace=wrap;html=1;fillColor=#23DE88', Math.cos(Math.PI/6) * 160, 160, '', 'Triangle', null, null, 'triangle logic inverter buffer'),
 	this.createVertexTemplateEntry('shape=parallelogram;aspect=fixed;editable=0;size=0.5;perimeter=parallelogramPerimeter;whiteSpace=wrap;html=1;fillColor=#C9AC8A', 240, 120, '', 'Parallelogram 2'),
 	];
 ...
 */
 Sidebar.prototype.addAttributeBlocksPalette = function (expand) {
 	...
 	var fns = [
 	this.createVertexTemplateEntry('triangle;editable=0;rotation=-90;aspect=fixed;whiteSpace=wrap;html=1;fillColor=#FDFD48', Math.cos(Math.PI / 6) * 120, 120, '', 'Triangle', null, null, 'triangle logic inverter buffer'),
 	this.createVertexTemplateEntry('shape=hexagon;editable=0;aspect=fixed;perimeter=hexagonPerimeter2;whiteSpace=wrap;html=1;fillColor=#FDFD48', 120, 100, '', 'Hexagon', null, null, 'hexagon preparation'),
 	this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;editable=0;html=1;aspect=fixed;fillColor=#FDFD48;', 120, 120, '', 'Circle', null, null, 'circle'),
 	this.createVertexTemplateEntry('whiteSpace=wrap;html=1;aspect=fixed;editable=0;fillColor=#FDFD48', 120, 120, '', 'Square', null, null, 'square'),
 	this.createVertexTemplateEntry('whiteSpace=wrap;html=1;aspect=fixed;editable=0;fillColor=#FDFD48', 50, 120, '', 'Square', null, null, 'square'),
 	];
 ...
 */
 ...
 Sidebar.prototype.createFractionCircleShape = function()
 {
 	...
 	this.addEntry('list group erd table', function()
 	{
 		...
 		return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, 'Green cube');
 	}),
 ...
 Sidebar.prototype.createFractionTileShape = function()
 {
	...
	return [
		this.addEntry('list group erd table', function()
		{
			...
			cell.vertex = true;
			cell.identity = "FractionTile";
			return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, 'Container');
		}),
		this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;fontColor=white;fontFamily=Comic Sans MS;fontStyle=1;fontSize=28;fontWeight=bold;html=1;fillColor=red;editable=0;resizable=0', fractionContainerWidth, fractionContainerHeight - 40, '1', '', null, null, 'rect rectangle box'),
		this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;fontColor=white;fontFamily=Comic Sans MS;fontStyle=1;fontSize=28;fontWeight=bold;html=1;fillColor=#873838;editable=0;resizable=0', fractionContainerWidth * (1/2), fractionContainerHeight - 40, '<span class="f"><div class="n">1</div><div class="d">2</div></span>', '', null, null, 'rect rectangle box'),
		this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;fontColor=white;fontFamily=Comic Sans MS;fontStyle=1;fontSize=12;html=1;fillColor=#282828;editable=0;resizable=0', fractionContainerWidth * (1/3), fractionContainerHeight - 40, '<span class="f"><div class="n">1</div><div class="d">3</div></span>', '', null, null, 'rect rectangle box'),
		this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;fontColor=white;fontFamily=Comic Sans MS;fontStyle=1;fontSize=12;html=1;fillColor=#F7E85C;editable=0;resizable=0', fractionContainerWidth * (1/4), fractionContainerHeight - 40, '<span class="f"><div class="n">1</div><div class="d">4</div></span>', '', null, null, 'rect rectangle box'),
		this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;fontColor=white;fontFamily=Comic Sans MS;fontStyle=1;fontSize=12;html=1;fillColor=#48CC74;editable=0;resizable=0', fractionContainerWidth * (1/5), fractionContainerHeight - 40, '<span class="f"><div class="n">1</div><div class="d">5</div></span>', '', null, null, 'rect rectangle box'),
		this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;fontColor=white;fontFamily=Comic Sans MS;fontStyle=1;fontSize=12;html=1;fillColor=#F98B38;editable=0;resizable=0', fractionContainerWidth * (1/6), fractionContainerHeight - 40, '<span class="f"><div class="n">1</div><div class="d">6</div></span>', '', null, null, 'rect rectangle box'),
		this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;fontColor=white;fontFamily=Comic Sans MS;fontStyle=1;fontSize=12;html=1;fillColor=#DD4050;editable=0;resizable=0', fractionContainerWidth * (1/8), fractionContainerHeight - 40, '<span class="f"><div class="n">1</div><div class="d">8</div></span>', '', null, null, 'rect rectangle box'),
		this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;fontColor=white;fontFamily=Comic Sans MS;fontStyle=1;fontSize=12;html=1;fillColor=#823D84;editable=0;resizable=0', fractionContainerWidth * (1/10), fractionContainerHeight - 40, '<span class="f"><div class="n">1</div><div class="d">10</div></span>', '', null, null, 'rect rectangle box'),
		this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;fontColor=white;fontFamily=Comic Sans MS;fontStyle=1;fontSize=12;html=1;fillColor=#D3487E;editable=0;resizable=0', fractionContainerWidth * (1/12), fractionContainerHeight - 40, '<span class="f"><div class="n">1</div><div class="d">12</div></span>', '', null, null, 'rect rectangle box')
	];
 }
 Sidebar.prototype.createConnectingCubesShape = function()
 {
 	...
 	field2.vertex = true;
 	var field3 = new mxCell('', new mxGeometry(0, 0, 80, 32), 'shape=umlFrame;editable=0;rotatable=0;deletable=0;fillColor=#C1C831;perimeter=stepPerimeter;fixedSize=1;points=[];resizable=0');
 	field3.vertex = true;
 	return [
 	this.addEntry('list group erd table', function()
 	{
 	...
 	}),this.addEntry('list group erd table', function()
 	{
 		...
 		cell.identity = 'cube-fraction';
 		return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, 'Purple cube');
 	}),
 	this.addEntry('list group erd table', function()
 	{
 		var cell = new mxCell('', new mxGeometry(0, 0, 400, 80),
 		...
 		cell.identity = 'cube-fraction';
 		return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, 'Red cube');
 	}),
 	this.addEntry('list group erd table', function()
 	{
 		var cell = new mxCell('', new mxGeometry(0, 0, 400, 80),
 		...
 		cell.identity = 'cube-fraction';
 		return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, 'Yellow cube');
 	})
 	];
 }
/**
