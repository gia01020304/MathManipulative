...
function saveFile() {
	...
	if (isNewFile == true) {
		$('#nameFile').modal('show');
		addMsgError("A clear file name would help you easily recognize your manipulation later.", 'FileName');
		return;
	}
	else {
...
function restore(xml, name) {
	...
	try {
		...
		//2019/10/10 gnguyen start add
		$('#geBackgroundPage').css("background-image",'');
		//2019/10/10 gnguyen end add
		if (img != null) {
