...
Sidebar.prototype.addNumberLine=function (expand){
	...
	this.addEntry(null,function () {
		...
		var cell = new mxCell(null, new mxGeometry(0, 0,600,230),
			'resizable=0;editable=0;aspect=fixed;shape=numberline');
		cell.vertex = true;
		
		var footer=new mxCell(null, new mxGeometry(0, 140,600,90),"movable=0;resizable=0;fillColor=white;rotatable=0;");
		footer.vertex=true;
		footer.connectable=false;


		var minimumLabel = graph.insertVertex(footer, null, 'Minimum',0.1, 0.5,0,0, 'movable=0;constituent=1;resizable=0;rotatable=0;editable=0', true);
		var minimum=graph.insertVertex(footer, null, '-5',0.15,0.4, 50, 25, 'movable=0;constituent=1;resizable=0;rotatable=0', true);
		minimum.identity="minimum";

		var interValLabel = graph.insertVertex(footer, null, 'Interval',0.3, 0.5,0,0, 'movable=0;constituent=1;resizable=0;rotatable=0;editable=0', true);
		var interVal=graph.insertVertex(footer, null, '1',0.35,0.4, 50, 25, 'movable=0;constituent=1;resizable=0;rotatable=0', true);
		interVal.identity="interVal";

		var maximumLabel = graph.insertVertex(footer, null, 'Maximum',0.5, 0.5,0,0, 'movable=0;constituent=1;resizable=0;rotatable=0;editable=0', true);
		var maximum=graph.insertVertex(footer, null, '5',0.55,0.4, 50, 25, 'movable=0;constituent=1;resizable=0;rotatable=0', true);
		maximum.identity="maximum";

		var build=new mxCell("Build", new mxGeometry(500,65,100,25),"movable=0;resizable=0;fillColor=#D7D7D7;constituent=1;rotatable=0;editable=0;");
		build.vertex=true;
...
Sidebar.prototype.addCentimeterCubes=function (expand) {
	...
	this.addEntry(null, function()
	{
		var cell = new mxCell(null, new mxGeometry(0, 0,30,30),
			'resizable=0;aspect=fixed;verticalAlign=top;align=left;spacingTop=8;spacingLeft=2;spacingRight=12;shape=cube;size=5;direction=south;fontStyle=4;html=1;fillColor=#0033CC;');
		cell.vertex = true;
...
Sidebar.prototype.addBaseTenBlock=function (expand) {
	...
	{
		var cell = new mxCell(null, new mxGeometry(0, 0,30,30),
			'resizable=0;aspect=fixed;verticalAlign=top;align=left;spacingTop=8;spacingLeft=2;spacingRight=12;shape=cube;size=5;direction=south;fontStyle=4;html=1;fillColor=#FFFF33;');
		cell.vertex = true;
