 ...
 (function()
 {
 	...
 	RulerStandard.prototype.paintVertexShape= function(c, x, y, w, h){
 		...
 		for (var i = 0; i <=widthRuler; i+=step) {
 			...
 			if (value<=150) {
 				var count=0;
 				for (var j = startRuler+i+step2; j < startRuler+i+step; j+=step2) {
 					c.moveTo(j,0);
 					if (count%2==0) {
 						c.lineTo(j,h/5);
 					}else{
 		...
 		// c.setStrokeWidth(1);
 		// c.setStrokeColor('black');
 		// var step=Math.floor(widthRuler/30);
 		// startRuler=20;
 		// for (var i = 0; i <=widthRuler; i+=step) {
 		// 	c.moveTo(startRuler+i,0);
 	...
 	RulerMetric.prototype.paintVertexShape= function(c, x, y, w, h){
 		...
 		// c.setStrokeWidth(1);
 		// c.setStrokeColor('black');
 		// var step=Math.floor(widthRuler/24);
 		...
 		// c.setStrokeWidth(1);
 		// c.setStrokeColor('black');
 		// var step=Math.floor(widthRuler/12);
