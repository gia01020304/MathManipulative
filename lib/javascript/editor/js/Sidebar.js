 ...
 */
 Sidebar.prototype.addPatternBlocksPalette = function (expand) {
 	...
 	this.createVertexTemplateEntry('shape=parallelogram;editable=0;aspect=fixed;perimeter=parallelogramPerimeter;whiteSpace=wrap;size=0.3;html=1;fillColor=#4357FF', 240, 120, '', ''),
 	this.createVertexTemplateEntry('shape=trapezoid;aspect=fixed;editable=0;perimeter=trapezoidPerimeter;whiteSpace=wrap;html=1;fillColor=#FE4847', 120, 60, '', ''),
 	this.createVertexTemplateEntry('shape=hexagon;aspect=fixed;editable=0;perimeter=hexagonPerimeter2;whiteSpace=wrap;html=1;fillColor=#FDFD48', 120, 100, '', '', null, null, 'hexagon preparation'),
 	...
 	this.createVertexTemplateEntry('shape=parallelogram;aspect=fixed;editable=0;size=0.5;perimeter=parallelogramPerimeter;whiteSpace=wrap;html=1;fillColor=#C9AC8A', 240, 120, '', ''),
 	];
 ...
 */
 Sidebar.prototype.addAttributeBlocksPalette = function (expand) {
 	...
 	this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;editable=0;html=1;aspect=fixed;fillColor=#FDFD48;', 120, 120, '', 'Circle', null, null, ''),
 ...
 */
 ...
 function setIntegerCounterFlipEvent(){
	...
	if ($('.scene').parent().length > 0) {
		$(".btn-perform-counter").off('click.perform touchstart');
		$(".btn-perform-counter").on('click.perform touchstart', function () {
			if(!isSafari){
