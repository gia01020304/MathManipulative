 ...
 */
 Actions.prototype.init = function()
 {
	...
	this.addAction('ruler',(elt)=>{
		...
		processTransferRuler(graph,"Metric","Ruler Metric",420,100,20,20,true);
	}, null, null, 'Ruler')
	...
	this.addAction('protractor',(elt)=>{
		...
		try {
			var pt = graph.getFreeInsertPoint();
			var v1 = graph.insertVertex(parent, null, null, pt.x,pt.y , 400, 200, 'resizable=0;aspect=fixed;shape=protractor');
			var symbol2 = new mxCell('', new mxGeometry(0.95,0,20,20),'resizable=0;aspect=fixed;rotationEnabled=0;constituent=1;');
			symbol2.value="X";
 ...
 */
 ...
 function processTransferRuler(graph,value,typeRuler,width,height,x,y,oldObject) {
 	...
 	try {
 		...
 		var v1 = graph.insertVertex(parent, null, null, pt.x, pt.y, width, height, 'resizable=0;aspect=fixed;shape='+typeRuler);
 		...
 		var symbol2 = new mxCell('', new mxGeometry(1,1,20,20),'resizable=0;aspect=fixed;rotationEnabled=0;constituent=1;');
 		symbol2.value="X";
 		symbol2.identity = "hide-ruler";
 		symbol2.connectable=false;
 		symbol2.geometry.relative = true;
