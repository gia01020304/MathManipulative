 ...
 */
 Sidebar.prototype.init = function()
 {
	...
	this.addAlberaTitlesPalette(false);
		...
		this.addImagePalette('money', '<img alt="Pattern blocks" style="width:100%;height=100%;" src="'+pathRelative+'/lib/images/money.png"/>', dir + '/moneys/', '',
...
Sidebar.prototype.addNumberLine=function (expand){
	...
	this.addEntry(null,function () {
		...
		var numberLine=graph.insertVertex(group, null,null, 0, 0, 600, 100, 'resizable=0;shape=numberline');
		numberLine.vertex=true;
		numberLine.geometry.relative = true;
		numberLine.connectable=false;
		var footer=new mxCell(null, new mxGeometry(0, 100,600,100),"resizable=0;fillColor=white");
		footer.vertex=true;
		footer.connectable=false;


		var minimumLabel = graph.insertVertex(footer, null, 'Minimum',0.1, 0.5,0,0, 'constituent=1;resizable=0;', true);
		var minimum=graph.insertVertex(footer, null, '-5',0.15,0.4, 50, 25, 'constituent=1;resizable=0;', true);

		var interValLabel = graph.insertVertex(footer, null, 'Interval',0.3, 0.5,0,0, 'constituent=1;resizable=0;', true);
		var interVal=graph.insertVertex(footer, null, '1',0.35,0.4, 50, 25, 'constituent=1;resizable=0;', true);

		var maximumLabel = graph.insertVertex(footer, null, 'Maximum',0.5, 0.5,0,0, 'constituent=1;resizable=0;', true);
		var maximum=graph.insertVertex(footer, null, '5',0.55,0.4, 50, 25, 'constituent=1;resizable=0;', true);

		var build=new mxCell("Build", new mxGeometry(500,75,100,25),"resizable=0;fillColor=#D7D7D7;constituent=1;");
		build.vertex=true;
 ...
 Sidebar.prototype.createFractionTileShape = function()
 {
 	...
 	this.addEntry('list group erd table', function()
 	{
 		var cell = new mxCell('Fraction Tile Container', new mxGeometry(0, 0, 400, 80),
 			...
 			'resizeParent=0;resizeParentMax=0;resizeLast=0;collapsible=1;marginBottom=0;');
 		cell.vertex = true;
 ...
 * Creates a drop handler for inserting the given cells.
 */
 Sidebar.prototype.createVertexTemplateEntry = function(style, width, height, value, title, showLabel, showTitle, tags,isBackground=false,id=null)
 {
 	...
 	return this.addEntry(tags, mxUtils.bind(this, function()
 	{
 		...
 		return this.createVertexTemplate(style, width, height, value, title, showLabel, showTitle,null,isBackground,id);
 	}));
 }
 ...
 * Creates a drop handler for inserting the given cells.
 */
 Sidebar.prototype.createVertexTemplate = function(style, width, height, value, title, showLabel, showTitle, allowCellsInserted,isBackground,id)
 {
