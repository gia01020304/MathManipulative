 ...
 */
 Sidebar.prototype.addAlberaTitlesPalette = function (expand) {
 	...
 	this.createVertexTemplateEntry('html=1;whiteSpace=wrap;aspect=fixed;fontFamily=Comic Sans MS;fontStyle=1;fillColor=#2C883E;', 40, 160, `<span style="font-size:${40 * 0.5}px;font-height:bold;">x</span>`, '', true, null, 'comic rectangle rect box text retro',false, 'algebra'),
 	this.createVertexTemplateEntry('html=1;whiteSpace=wrap;aspect=fixed;fontFamily=Comic Sans MS;fontStyle=1;fillColor=#D13433;', 40, 160, `<span style="font-size:${40 * 0.5}px;font-height:bold;">-x</span>`, '', true, null, 'comic rectangle rect box text retro',false, 'algebra'),
 	this.createVertexTemplateEntry('html=1;whiteSpace=wrap;aspect=fixed;fontFamily=Comic Sans MS;fontStyle=1;fillColor=yellow;', 60, 60, `<span style="font-size:${60 * 0.5}px;font-height:bold;">1</span>`, '', true, null, 'comic rectangle rect box text retro',false, 'algebra'),
 	this.createVertexTemplateEntry('html=1;whiteSpace=wrap;aspect=fixed;fontFamily=Comic Sans MS;fontStyle=1;fillColor=#D13433;', 60, 60, `<span style="font-size:${60 * 0.5}px;font-height:bold;">-1</span>`, '', true, null, 'comic rectangle rect box text retro',false, 'algebra'),
 	];
