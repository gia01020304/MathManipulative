 ...
 */
 Actions.prototype.init = function()
 {
	...
	this.addAction('protractor',(elt)=>{
		...
		try {
			var pt = graph.getFreeInsertPoint();
			var v1 = graph.insertVertex(parent, null, null, pt.x,pt.y , 400, 275, 'resizable=0;aspect=fixed;shape=protractor');
 ...
 */
 ...
 function processTransferRuler(graph,value,typeRuler,width,height,x,y,oldObject) {
 	...
 	try {
 		...
 		var v1 = graph.insertVertex(parent, null, null, x, y, width, height, 'resizable=0;aspect=fixed;shape='+typeRuler);
