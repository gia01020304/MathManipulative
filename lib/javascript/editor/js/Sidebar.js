 ...
 */
 Sidebar.prototype.addIntegerCounterPaletteWhenNotSupport = function (expand) {
 	...
 	this.createVertexTemplateEntry('text;html=1;fillColor=#ffffff;overflow=fill;rounded=0;editable=0;aspect=fixed;', 250, 250,
 		...
 		<div class="counter-card-not-support red-color">
 		</div>
 		</div>
 		<i class="fas fa-redo-alt btn-perform btn-perform-counter" title="Flip"></i>
 		`, '', null, null, null, false, 'testKing'),

 	this.createVertexTemplateEntry('text;html=1;fillColor=#ffffff;overflow=fill;rounded=0;editable=0;aspect=fixed;', 250, 250,
 		`<div class="scene scene--card" style="width:80%;height:80%;">
 		<div class="counter-card-not-support yellow-color">
 		</div>
 		</div>
 		<i class="fas fa-redo-alt btn-perform btn-perform-counter" title="Flip"></i>
 		`, '', null, null, null, false, 'testKing'),
 	...
 	this.createVertexTemplateEntry('text;html=1;fillColor=#ffffff;overflow=fill;rounded=0;editable=0;aspect=fixed;', 250, 250,
 		`<div class="scene scene--card" style="width:80%;height:80%;">
 		<div class="counter-card-not-support purple-color">
 		</div>
 		</div>
 		<i class="fas fa-redo-alt btn-perform btn-perform-counter" title="Flip"></i>
 		`, '', null, null, null, false, 'testKing'),
 	...
 	this.createVertexTemplateEntry('text;html=1;fillColor=#ffffff;overflow=fill;rounded=0;editable=0;aspect=fixed;', 250, 250,
 		`<div class="scene scene--card" style="width:80%;height:80%;">
 		<div class="counter-card-not-support green-color">
 		</div>
 		</div>
 		<i class="fas fa-redo-alt btn-perform btn-perform-counter" title="Flip"></i>
 		`, '', null, null, null, false, 'testKing'),
 ...
 Sidebar.prototype.addIntegerCounterPalette = function (expand) {
 	...
 	var fns = [
 	this.createVertexTemplateEntry('text;html=1;fillColor=#ffffff;overflow=fill;rounded=0;editable=0;', 80, 60,
 		...
 		<i class="fas fa-redo-alt btn-perform-test btn-perform btn-perform-counter" title="Flip"></i>
 		</div>
 		`, '', null, null, null, false, 'testKing'),
 ...
 Sidebar.prototype.addClock=function (expand){
 	var fns =[
 	this.createVertexTemplateEntry('resizable=0;editable=0;aspect=fixed;shape=clock;', 300, 300, '', ''),
 	];
 ...
 Sidebar.prototype.addThermometer=function (expand){
 	var fns =[
 	this.createVertexTemplateEntry('aspect=fixed;shape=QUICKSCROLL;editable=0;', 250, 450, '', 'Thermometer'),
 	];
...
Sidebar.prototype.addNumberLine=function (expand){
	...
	this.addEntry(null,function () {
		...
		var cell = new mxCell(null, new mxGeometry(0, 0,490,180),
			'editable=0;resizable=0;aspect=fixed;shape=numberline;Maximum=5;Minimum=-5;Interval=1');
...
Sidebar.prototype.addCentimeterCubes=function (expand) {
	...
	this.addEntry(null, function()
	{
		var cell = new mxCell(null, new mxGeometry(0, 0,44,44),
			'editable=0;resizable=0;aspect=fixed;verticalAlign=top;align=left;spacingTop=8;spacingLeft=2;spacingRight=12;shape=cube;size=5;direction=south;fontStyle=4;html=1;fillColor=#0033CC;');
		cell.vertex = true;
 ...
 */
 Sidebar.prototype.addAlberaTitlesPalette = function (expand) {
 	...
 	var fns = [
 	this.createVertexTemplateEntry('html=1;whiteSpace=wrap;aspect=fixed;fontFamily=Comic Sans MS;fontStyle=1;fillColor=#D13433;', 160, 160, `<span style="font-size:${160 * 0.5}px;font-height:bold;">-x<sup>2</sup></span>`, '', true, null, 'comic rectangle rect box text retro',false, 'algebra'),
 	this.createVertexTemplateEntry('html=1;whiteSpace=wrap;aspect=fixed;fontFamily=Comic Sans MS;fontStyle=1;fillColor=#6DB0CE;', 160, 160, `<span style="font-size:${160 * 0.5}px;font-height:bold;">x<sup>2</sup> </span>`, '', true, null, 'comic rectangle rect box text retro',false, 'algebra'),
 	this.createVertexTemplateEntry('html=1;whiteSpace=wrap;aspect=fixed;fontFamily=Comic Sans MS;fontStyle=1;fillColor=#2C883E;', 160, 40, `<span style="font-size:${40 * 0.5}px;font-height:bold;">x</span>`, '', true, null, 'comic rectangle rect box text retro',false, 'algebra'),
 	this.createVertexTemplateEntry('html=1;whiteSpace=wrap;aspect=fixed;fontFamily=Comic Sans MS;fontStyle=1;fillColor=#D13433;', 160, 40, `<span style="font-size:${40 * 0.5}px;font-height:bold;">-x</span>`, '', true, null, 'comic rectangle rect box text retro',false, 'algebra'),
 	this.createVertexTemplateEntry('html=1;whiteSpace=wrap;aspect=fixed;fontFamily=Comic Sans MS;fontStyle=1;fillColor=yellow;', 40, 40, `<span style="font-size:${40 * 0.5}px;font-height:bold;">1</span>`, '', true, null, 'comic rectangle rect box text retro',false, 'algebra'),
 	this.createVertexTemplateEntry('html=1;whiteSpace=wrap;aspect=fixed;fontFamily=Comic Sans MS;fontStyle=1;fillColor=#D13433;', 40, 40, `<span style="font-size:${40 * 0.5}px;font-height:bold;">-1</span>`, '', true, null, 'comic rectangle rect box text retro',false, 'algebra'),
 	];
 ...
 */
 Sidebar.prototype.addAttributeBlocksPalette = function (expand) {
 	...
 	var fns = [
 	this.createVertexTemplateEntry('triangle;editable=0;rotation=-90;aspect=fixed;whiteSpace=wrap;html=1;fillColor=#FDFD48;resizable=0;rotatable=1;', Math.cos(Math.PI / 6) * 120, 120, '', '', null, null, 'triangle logic inverter buffer'),
 	this.createVertexTemplateEntry('shape=hexagon;editable=0;aspect=fixed;perimeter=hexagonPerimeter2;whiteSpace=wrap;html=1;fillColor=#FDFD48;resizable=1;rotatable=1;', 120, 100, '', '', null, null, 'hexagon preparation'),
 	this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;editable=0;html=1;aspect=fixed;fillColor=#FDFD48;resizable=1;rotatable=1;', 120, 120, '', '', null, null, ''),
 	this.createVertexTemplateEntry('whiteSpace=wrap;html=1;aspect=fixed;editable=0;fillColor=#FDFD48;resizable=1;rotatable=1;', 120, 120, '', '', null, null, 'square'),
 	this.createVertexTemplateEntry('whiteSpace=wrap;html=1;aspect=fixed;editable=0;fillColor=#FDFD48;resizable=1;rotatable=1;', 50, 120, '', '', null, null, 'square'),
 	];
 ...
 */
 ...
 Sidebar.prototype.createFractionTileShape = function()
 {
 	...
 	this.addEntry('list group erd table', function()
 	{
 		var cell = new mxCell('<span class="fraction-title">Fraction Tile Container</span>', new mxGeometry(0, 0, fractionContainerWidth, fractionContainerHeight),
 			...
 			'resizeParent=0;resizeParentMax=0;resizeLast=0;collapsible=1;marginBottom=0;;editable=0;shadow=1;collapsible=0');
 		cell.vertex = true;
 ...
 {
 	var sb = this;
 	var field = new mxCell('', new mxGeometry(0, 0, 80, 32), 'shape=umlFrame;editable=0;deletable=0;rotatable=0;fillColor=#64AA50;perimeter=stepPerimeter;fixedSize=1;points=[];resizable=0;');
 	field.vertex = true;
 	...
 	this.addEntry('list group erd table', function()
 	{
 		var cell = new mxCell('', new mxGeometry(0, 0, 400, 80),
 			'childLayout=stackLayout;horizontal=1;fillColor=none;horizontalStack=1;resizeParent=1;resizeParentMax=0;resizeLast=0;collapsible=0;strokeColor=none;stackBorder=10;stackSpacing=-12;resizable=1;align=center;points=[];fontColor=#000000;');
 		cell.vertex = true;
 		cell.insert(sb.cloneCell(field, ''));
 ...
 function setIntegerCounterFlipEvent(){
 	...
 	if ($('.scene').parent().length > 0) {
 		...
 		$(".btn-perform-counter").on('click.perform touchmove', function (e) {
 			if(!isSafari){
 				var integerCounter = $(this).siblings('.scene').children('.counter-card');
 				$(integerCounter).toggleClass('is-flipped');
 			} else {
 				var integerCounterFace = $(this).siblings('.scene').children('.counter-card-not-support');
 ...
 * Creates a drop handler for inserting the given cells.
 */
 Sidebar.prototype.createVertexTemplateEntry = function(style, width, height, value, title, showLabel, showTitle, tags,isBackground=false,id=null, image = '',imageOpposite = '')
 {
 	...
 	return this.addEntry(tags, mxUtils.bind(this, function()
 	{
 		...
 		return this.createVertexTemplate(style, width, height, value, title, showLabel, showTitle,null,isBackground,id, image, imageOpposite);
 	}));
 }
 ...
 * Creates a drop handler for inserting the given cells.
 */
 Sidebar.prototype.createVertexTemplate = function(style, width, height, value, title, showLabel, showTitle, allowCellsInserted,isBackground,id,image = '', imageOpposite = '')
 {
 ...
 Sidebar.prototype.addMoneyPalette = function(id, title, prefix, postfix, items, titles, tags)
 {
 	...
 	for (var i = 0; i < items.length; i++)
 	{
 		(mxUtils.bind(this, function(item, title, tmpTags)
 		{
 			...
 			fns.push(this.createVertexTemplateEntry('image;html=1;editable=0;aspect=fixed;labelBackgroundColor=#ffffff;image=' + prefix + item + postfix,
 				this.defaultImageWidth * 3, this.defaultImageHeight * 1.8, '', title, title != null, null, this.filterTags(tmpTags), false, "money",prefix + item + postfix, prefix + imageOpposite + postfix));
 		}))(items[i], (titles != null) ? titles[i] : null, (tags != null) ? tags[items[i]] : null);
 	}
