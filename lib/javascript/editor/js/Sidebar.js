...
Sidebar.prototype.addIntegerCounterPaletteWhenNotSupport = function (expand) {
 ...
 Sidebar.prototype.addIntegerCounterPalette = function (expand) {
	 ...
	 this.createVertexTemplateEntry('text;html=1;fillColor=#ffffff;overflow=fill;rounded=0;editable=0;', 250, 250,
	 `<div class="scene scene--card" style="width:80%;height:80%;">
	 <div class="counter-card">
	 <div class="card__face card__face--front red-color"></div>
	 <div class="card__face card__face--back yellow-color"></div>
...
Sidebar.prototype.addBaseTenBlock=function (expand) {
	...
	this.addEntry(null,function () {
		...
		return sb.createVertexTemplateFromCells([c], c.geometry.width, c.geometry.height, '');
	}),
	this.addEntry(null,function () {
		var g1=[];
		for (var j = 0; j <10 ; j++) {
 ...
 */
 Sidebar.prototype.createItem = function(cells, title, showLabel, showTitle, width, height, allowCellsInserted,isBackground)
 {
 	var elt = document.createElement('a');
 ...
 * Creates a drop handler for inserting the given cells.
 */
 Sidebar.prototype.createVertexTemplateFromCells = function(cells, width, height, title, showLabel, showTitle, allowCellsInserted,isBackground)
 {
	...
	return this.createItem(cells, title, showLabel, showTitle, width, height, allowCellsInserted,isBackground);
};
