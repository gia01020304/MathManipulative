 ...
 */
 (function()
 {
 	...
 	Protractor.prototype.paintVertexShape= function(c, x, y, w, h){
 		// debugger;
 		// var x4=mxUtils.getValue(this.state.style,'x1',this.x1);
 		// var y4=mxUtils.getValue(this.state.style,'y1',this.y1);
 	...
 	NumberLine.prototype.paintVertexShape = function(c, x, y, w, h){
 		...
 		var total=(NumberLine.prototype.cst.Maximum+Math.abs(NumberLine.prototype.cst.Minimum))/NumberLine.prototype.cst.Interval;
 		var step=Math.round(end/total);
 		...
 		for (var i = 0; i <=end; i+=step) {
 			...
 			c.setFontSize (20);
 			c.text(start+i,currentPositionY+15,0,0,value.toString(),'center');
