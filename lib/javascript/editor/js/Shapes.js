 ...
 */
 (function()
 {
	...
	Clock.prototype.paintBackground = function(c, x, y, w, h)
	{
		...
		var x11=xh-r;
		var y11=yh-r;
		var radi=calcAngleDegrees(x11,y11)*-1;
		var x12=(r+r3*findX(radi));
		var y12=(r-r3*findY(radi));	
		c.moveTo(x12,y12);
		var x13,y13,x14,y14;
		x13=r+(r3-3)*findX(radi-2);
		y13=r-(r3-3)*findY(radi-2);
		x14=r+(r3-3)*findX(radi+2);
		y14=r-(r3-3)*findY(radi+2);
		c.lineTo(x13,y13);
		c.lineTo(x14,y14);
		c.lineTo(x12,y12);
		c.moveTo(x12,y12);
