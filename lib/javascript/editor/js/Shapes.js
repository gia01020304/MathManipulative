 	...
 	function createNumberLineHandles()
 	{
 		...
 		{	
 			...
 			handles.push(Graph.createHandle(state, ['radi'], function(bounds)
 			{
 				...
 				return new mxPoint(bounds.x+start,bounds.height/2);
 			}, function(bounds, pt)
 			{	
 				var range={
 					top:bounds.height/2,
 					...
 					right:bounds.width-bounds.width/30,
 				}
