	...
	this.addAction(
		...
		try {
			...
			var cell = graph.insertVertex(
				...
				400,
				275,
				"editable=0;resizable=0;aspect=fixed;shape=protractor"
				);
			cell.identity = "protractor";
			var symbol2 = new mxCell(
				"",
				new mxGeometry(0.95, 0, 20, 20),
				"editable=0;resizable=0;aspect=fixed;rotationEnabled=0;constituent=1;strokeColor=#002FA7;fontColor=#002FA7"
				);
			symbol2.value = "X";
...
function processTransferRuler(
	...
	var cell = graph.insertVertex(
		...
		width + 40 + 20,
		100,
		"rotationEnabled=0;editable=0;resizable=0;aspect=fixed;shape=" + typeRuler
		);
	cell.identity = "ruler";
	...
	var symbol2 = new mxCell(
		...
		"editable=0;resizable=0;aspect=fixed;rotationEnabled=0;strokeColor=#002FA7;fontColor=#002FA7"
		);
	symbol2.value = "X";
	symbol2.identity = "hide-ruler";
	symbol2.connectable = false;
