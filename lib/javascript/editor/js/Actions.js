 ...
 */
 Actions.prototype.init = function()
 {
	...
	// 				var g1=[];
	// 				for (var j = 0; j < 10; j++) {
	// 					var v1 = graph.insertVertex(parent, null, null,50+i*25+k*5,50+j*25+k*5,25,25,"fillColor=#D97C3D;");
	// 					g1.push(v1);
	// 				}
			
	// 				g2.push(graph.groupCells(null, 0,g1));
	// 			}
	// 			g3.push(graph.groupCells(null, 0,g2));
	// 		}
	// 		graph.groupCells(null, 0,g3)
	// 	} finally
	// 	{
	// 		graph.getModel().endUpdate();
	// 	}
 ...
 */
 ...
 function processProtractor(graph,nameShape,width,height,x,y) {
 	...
 	// 			node.innerHTML="Click";
 	// 			node.style.background = 'red';
 	// 			node.style.height="100%";
 	// 			node.setAttribute('height', "100%");
 	// 			var x = document.createElement("INPUT");
 	// 			x.setAttribute("type", "text");
 	// 			x.addEventListener('click', function (argument) {
 	// 				$(this).focus();
 	// 			})
 	// 			node.appendChild(x);
 	// 			return node;
 	...
 	// 			node.addEventListener('click', function (argument) {
